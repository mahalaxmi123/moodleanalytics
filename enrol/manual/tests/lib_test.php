...
class enrol_manual_lib_testcase extends advanced_testcase {
    ...
    public function test_migrate_plugin_enrolments() {
        ...
        // We expect manual, self, guest and corplms_program instances to be created by default.
        ...
        $this->assertEquals(5, $DB->count_records('enrol', array('enrol'=>'corplms_program')));
