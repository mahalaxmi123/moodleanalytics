...
class enrol_corplms_facetoface_external extends external_api {
    ...
    public static function get_instance_info_parameters() {
        return new external_function_parameters(
            array('instanceid' => new external_value(PARAM_INT, 'instance id of corplms_facetoface enrolment plugin.'))
        );
    }

    /**
     * Return corplms_facetoface-enrolment instance information.
     *
     * @param int $instanceid instance id of corplms_facetoface enrolment plugin.
    ...
    public static function get_instance_info($instanceid) {
        ...
        // Retrieve corplms_facetoface enrolment plugin.
        $enrolplugin = enrol_get_plugin('corplms_facetoface');
