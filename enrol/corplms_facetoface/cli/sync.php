...
if ($options['help']) {
    $help =
        "Execute corplms_facetoface course enrol updates.
...
Example:
\$ sudo -u www-data /usr/bin/php enrol/corplms_facetoface/cli/sync.php
";
...
if (!enrol_is_enabled('corplms_facetoface')) {
    cli_error('enrol_corplms_facetoface plugin is disabled, synchronisation stopped', 2);
}
