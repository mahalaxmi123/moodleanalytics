...
/**
 * Face-to-Face Direct enrolment plugin - support for user corplms_facetoface unenrolment.
 */
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'corplms_facetoface'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/corplms_facetoface/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_corplms_facetoface', format_string($course->fullname));
