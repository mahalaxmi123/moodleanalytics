...
/**
 * Strings for component 'enrol_corplms_facetoface', language 'en'.
 */
...
$string['corplms_facetoface:config'] = 'Configure Face-to-Face Direct enrolment instances';
$string['corplms_facetoface:manage'] = 'Manage Face-to-Face Direct enrolled users';
$string['corplms_facetoface:unenrol'] = 'Unenrol Face-to-Face Direct enrolment users from course';
$string['corplms_facetoface:unenrolself'] = 'Unenrol self from the course and Face-to-Face sessions';
