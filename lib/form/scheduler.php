...
class MoodleQuickForm_scheduler extends MoodleQuickForm_group {
    ...
    function _createElements() {
        ...
        foreach (scheduler::get_options() as $option => $code) {
            $frequencyselect[$code] = get_string('schedule' . $option, 'corplms_reportbuilder');
        }
        ...
        $this->_elements['frequency'] = @MoodleQuickForm::createElement('select', 'frequency', get_string('schedule', 'corplms_reportbuilder'), $frequencyselect);
