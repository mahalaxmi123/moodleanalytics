...
function reminder_email_substitutions($content, $user, $course, $message, $reminder) {
    ...
    // User details
    $place[] = get_string('placeholder:firstname', 'corplms_coursecatalog');
    $subs[] = $user->firstname;
    $place[] = get_string('placeholder:lastname', 'corplms_coursecatalog');
    $subs[] = $user->lastname;

    // Course details
    $place[] = get_string('placeholder:coursepageurl', 'corplms_coursecatalog');
    $subs[] = "{$CFG->wwwroot}/course/view.php?id={$course->id}";
    $place[] = get_string('placeholder:coursename', 'corplms_coursecatalog');
    $subs[] = $course->fullname;

    // Manager name
    $place[] = get_string('placeholder:managername', 'corplms_coursecatalog');
    $subs[] = $user->manager ? fullname($user->manager) : get_string('nomanagermessage', 'corplms_coursecatalog');

    // Day counts
    $place[] = get_string('placeholder:dayssincecompletion', 'corplms_coursecatalog');
    $subs[] = $message->period;
    $place[] = get_string('placeholder:daysuntildeadline', 'corplms_coursecatalog');
