...
class moodle_page {
    ...
    /**
     * Corplms specific Page variable
     */
    protected $_corplms_menu_selected = null;
    ...
    /**
     * Returns the corplms menu selected string
     * @return String corplms_menu_selected
     */
    protected function magic_get_corplms_menu_selected() {
        return $this->_corplms_menu_selected;
    }
     ...
     */
    public function set_corplms_menu_selected($menuitemname) {
        $this->_corplms_menu_selected = $menuitemname;
    }
    ...
    protected function resolve_theme() {
        ...
        foreach ($themeorder as $themetype) {
            switch ($themetype) {
                ...
                case 'corplmspdf':
                    // Enforce corplms theme in PDF outputs - standardcorplms is not available any more.
                    return 'corplms';
                break;
