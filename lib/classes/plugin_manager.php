    ...
    public static function is_deleted_standard_plugin($type, $name) {
        ...
        $plugins = array(
            ...
            'theme' => array('mymobile', 'afterburner', 'anomaly', 'arialist', 'binarius', 'boxxie', 'brick', 'formal_white',
                ...
                // Corplms uninstalled themes.
                , 'clean', 'more', 'customcorplms', 'kiwifruit', 'standardcorplms',
            ),
        );
    ...
    public static function standard_plugins_list($type) {
        ...
        $standard_plugins = array(
            ...
            'block' => array(
                ...
                // Corplms
                ,'corplms_addtoplan', 'corplms_alerts',
                'corplms_my_learning_nav', 'corplms_my_team_nav', 'corplms_quicklinks',
                'corplms_recent_learning', 'corplms_report_graph', 'corplms_report_manager', 'corplms_stats',
                'corplms_tasks', 'facetoface', 'corplms_certifications', 'gaccess',
            ),
            ...
            'enrol' => array(
                ...
                'paypal', 'self'
                // Corplms
                , 'corplms_learningplan', 'corplms_program', 'corplms_facetoface',
            ),
            ...
            'theme' => array(
                'base', 'bootstrapbase'
                // Corplms:
                , 'kiwifruitresponsive', 'corplms', 'customcorplmsresponsive'
            ),
            ...
            'tool' => array(
                ...
                // Corplms:
                , 'corplms_sync', 'corplms_timezonefix'
            ),
