...
/**
* Corplms textarea options
*/

$corplms_maxbytes = get_max_upload_file_size();
$corplms_context = context_system::instance();
global $TEXTAREA_OPTIONS;
$TEXTAREA_OPTIONS = array(
        'subdirs' => 0,
        'maxfiles' => EDITOR_UNLIMITED_FILES,
        'maxbytes' => $corplms_maxbytes,
        'trusttext' => false,
        'context' => $corplms_context,
        'collapsed' => true
);
...
abstract class moodleform {
    ...
    public $_form; //CORPLMS: changed to public var to allow dialogs to use mforms easily.
