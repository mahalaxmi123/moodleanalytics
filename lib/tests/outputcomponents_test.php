...
class core_outputcomponents_testcase extends advanced_testcase {
    ...
    public function test_get_url() {
        ...
        $this->assertSame('corplms', $CFG->theme);
        ...
        $this->assertSame($CFG->wwwroot.'/pluginfile.php/'.$context1->id.'/user/icon/corplms/f2?rev=1', $up1->get_url($page, $renderer)->out(false));
        $user1->picture = 11;
        ...
        $this->assertSame($CFG->wwwroot.'/pluginfile.php/'.$context1->id.'/user/icon/corplms/f2?rev=11', $up1->get_url($page, $renderer)->out(false));
        ...
        $this->assertEquals($reads, $DB->perf_get_reads());
        $this->assertSame($CFG->wwwroot.'/theme/image.php/corplms/core/1/u/f2', $up2->get_url($page, $renderer)->out(false));
        $this->assertEquals($reads, $DB->perf_get_reads());
        ...
        $this->assertEquals($reads, $DB->perf_get_reads());
        $this->assertSame($CFG->wwwroot.'/theme/image.php/corplms/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));
        $this->assertEquals($reads, $DB->perf_get_reads());
        ...
        $up3 = new user_picture($user3);
        $this->assertEquals($reads, $DB->perf_get_reads());
        $this->assertEquals($CFG->wwwroot.'/theme/image.php/corplms/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('http://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Fmoodle%2Ftheme%2Fcorplms%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        $up1 = new user_picture($user1);
        $this->assertSame($CFG->httpswwwroot.'/pluginfile.php/'.$context1->id.'/user/icon/corplms/f2?rev=11', $up1->get_url($page, $renderer)->out(false));

        $up3 = new user_picture($user3);
        $this->assertSame($CFG->httpswwwroot.'/theme/image.php/corplms/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));

        $up2 = new user_picture($user2);
        $this->assertSame('https://secure.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=https%3A%2F%2Fwww.example.com%2Fmoodle%2Ftheme%2Fcorplms%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        $up3 = new user_picture($user3);
        $this->assertSame($CFG->wwwroot.'/theme/image.php?theme=corplms&component=core&rev=1&image=u%2Ff2', $up3->get_url($page, $renderer)->out(false));
