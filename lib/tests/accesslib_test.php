...
class core_accesslib_testcase extends advanced_testcase {
    ...
    public function test_get_all_roles() {
        ...
        $this->assertCount(12, $allroles); // there are 12 roles in standard corplms install
    ...
    public function test_get_role_archetypes() {
        ...
        $this->assertCount(10, $archetypes); // there are 9+1 archetypes in standard corplms install
