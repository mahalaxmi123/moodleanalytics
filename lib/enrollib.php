...
function enrol_get_all_users_courses($userid, $onlyactive = false, $fields = NULL, $sort = 'visible DESC,sortorder ASC') {
    ...
    list($visibilitysql, $visibilityparams) = corplms_visibility_where($userid, 'c.id', 'c.visible', 'c.audiencevisible');
...
abstract class enrol_plugin {
    ...
    public function enrol_user(stdClass $instance, $userid, $roleid = null, $timestart = 0, $timeend = 0, $status = null, $recovergrades = null) {
        ...
        if ($inserted) {
            ...
            $event->trigger();
            // Corplms "completion starts on enrol" event.
            $completionevent = \corplms_core\event\user_enrolment::create(
                    array(
                        'objectid'  => $ue->id,
                        'context'   => $context,
                        'other' => array(
