...
$string['clialreadyconfigured'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to install Corplms for this site.';
$string['clialreadyinstalled'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to upgrade Corplms for this site.';
...
$string['phpversionhelp'] = '<p>Corplms requires a PHP version of at least 5.3.2</p>
