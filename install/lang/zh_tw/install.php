...
$string['clialreadyconfigured'] = '檔案 config.php  已經存在，請使用dmin/cli/install_database.php來為這網站安裝Corplms。';
$string['clialreadyinstalled'] = '檔案 config.php  已經存在，請使用dmin/cli/install_database.php來為這網站安裝Corplms。';
