...
// If we were monitoring whether this was a fresh Corplms install we can stop now.
if (isset($CFG->corplmscoreinstallation)) {
    unset_config('corplmscoreinstallation');
}
