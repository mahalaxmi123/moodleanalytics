...
if (!during_initial_install()) { //do not use during installation
    ...
    if ($hassiteconfig or has_any_capability(array(
        ...
        $temp->add(new admin_setting_configcheckbox('courseprogress', new lang_string('courseprogress','corplms_core'), new lang_string('courseprogresshelp','corplms_core'), 0));
