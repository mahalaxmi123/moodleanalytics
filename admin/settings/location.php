...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('csvdateformat', new lang_string('csvdateformat', 'corplms_core'), new lang_string('csvdateformatconfig', 'corplms_core'), new lang_string('csvdateformatdefault', 'corplms_core')));
