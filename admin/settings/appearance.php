...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    $temp = new admin_settingpage('themesettings', new lang_string('themesettings', 'admin'),  array('corplms/core:appearance'));
    ...
    $ADMIN->add('themes', new admin_externalpage('themeselector', new lang_string('themeselector','admin'), $CFG->wwwroot . '/theme/index.php', array('corplms/core:appearance')));
    $ADMIN->add('themes', new admin_externalpage('elementlibrary', new lang_string('elementlibrary','corplms_core'), $CFG->wwwroot . '/elementlibrary/index.php', array('corplms/core:appearance')));
    ...
    foreach (core_component::get_plugin_list('theme') as $theme => $themedir) {
        ...
        if (file_exists($settings_path)) {
            $settings = new admin_settingpage('themesetting'.$theme, new lang_string('pluginname', 'theme_'.$theme), array('corplms/core:appearance'));
    ...
    // Calendar settings.
    $temp = new admin_settingpage('calendar', new lang_string('calendarsettings','admin'), array('corplms/core:appearance'));
    ...
    // blog
    $temp = new admin_settingpage('blog', new lang_string('blog','blog'), array('corplms/core:appearance'), empty($CFG->enableblogs));
    ...
    // Navigation settings
    $temp = new admin_settingpage('navigation', new lang_string('navigation'), array('corplms/core:appearance'));
    $choices = array(
    ...
    $ADMIN->add('appearance', $temp);
     ...
     // Corplms navigation.
    $ADMIN->add('appearance', new admin_externalpage('corplmsnavigation', new lang_string('corplmsnavigation', 'corplms_core'),
            new moodle_url('/corplms/core/menu/index.php'), array('corplms/core:editmainmenu')));

    // "htmlsettings" settingpage
    $temp = new admin_settingpage('htmlsettings', new lang_string('htmlsettings', 'admin'), array('corplms/core:appearance'));
    ...
    $temp = new admin_settingpage('documentation', new lang_string('moodledocs'), array('corplms/core:appearance'));
    ...
    $temp = new admin_settingpage('coursecontact', new lang_string('courses'), array('corplms/core:appearance'));
    ...
    $temp = new admin_settingpage('ajax', new lang_string('ajaxuse'), array('corplms/core:appearance'));
    ...
    $ADMIN->add('appearance', new admin_externalpage('managetags', new lang_string('managetags', 'tag'), $CFG->wwwroot.'/tag/manage.php', array('corplms/core:appearance')));

    $temp = new admin_settingpage('additionalhtml', new lang_string('additionalhtml', 'admin'), array('corplms/core:appearance'));
