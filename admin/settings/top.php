...
$ADMIN->add('root', new admin_externalpage('corplmsregistration', new lang_string('corplmsregistration', 'corplms_core'),
...
$ADMIN->add('root', new admin_category('hierarchies', new lang_string('hierarchies','corplms_hierarchy')));
$ADMIN->add('root', new admin_category('corplms_plan', new lang_string('learningplans', 'corplms_plan'),
    corplms_feature_disabled('learningplans')
));
$ADMIN->add('root', new admin_category('appraisals', new lang_string('appraisals', 'corplms_appraisal'),
    (corplms_feature_disabled('appraisals') && corplms_feature_disabled('feedback360'))
));
