...
if ($hassiteconfig
 ...
 or has_capability('moodle/cohort:view', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    $ADMIN->add('accounts', new admin_externalpage('cohortglobalsettings', new lang_string('cohortglobalsettings', 'corplms_cohort'), $CFG->wwwroot . '/corplms/cohort/globalsettings.php', array('moodle/cohort:manage', 'moodle/cohort:view')));
    ...
    $temp->add(new admin_setting_heading('tempmanagers',
            new lang_string('tempmanagers', 'corplms_core'), ''));

    $temp->add(new admin_setting_configcheckbox('enabletempmanagers',
            new lang_string('enabletempmanagers', 'corplms_core'),
            new lang_string('enabletempmanagersdesc', 'corplms_core'),
            1));

    $temp->add(new admin_setting_configselect('tempmanagerrestrictselection',
            new lang_string('tempmanagerrestrictselection', 'corplms_core'),
            new lang_string('tempmanagerrestrictselectiondesc', 'corplms_core'),
            0,
            array(0 => get_string('tempmanagerselectionallusers', 'corplms_core'),
                  1 => get_string('tempmanagerselectiononlymanagers', 'corplms_core'))));

    $temp->add(new admin_setting_configtext('tempmanagerexpirydays',
            new lang_string('tempmanagerexpirydays', 'corplms_core'),
            new lang_string('tempmanagerexpirydaysdesc', 'corplms_core'),
            '30', PARAM_INT));
    ...
    $ADMIN->add('roles', new admin_externalpage('roledefaults', new lang_string('roledefaults', 'corplms_core'), "$CFG->wwwroot/$CFG->admin/roles/roledefaults.php", 'moodle/role:manage'));
