...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) {
    ...
    $ADMIN->add('courses', new admin_externalpage('programmgmt', new lang_string('manageprograms', 'admin'),
        $CFG->wwwroot . '/corplms/program/manage.php',
        array('corplms/program:createprogram', 'corplms/program:configuredetails'),
        corplms_feature_disabled('programs')
    ));

    $ADMIN->add('courses', new admin_externalpage('managecertifications', new lang_string('managecertifications', 'corplms_core'),
        $CFG->wwwroot . '/corplms/program/manage.php?viewtype=certification',
        array('corplms/certification:createcertification', 'corplms/certification:configurecertification'),
        corplms_feature_disabled('certifications')
    ));

    $ADMIN->add('courses', new admin_externalpage('coursecustomfields', new lang_string('customfields', 'corplms_customfield'),
        $CFG->wwwroot . '/corplms/customfield/index.php?prefix=course',
        array('corplms/core:createcoursecustomfield', 'corplms/core:updatecoursecustomfield', 'corplms/core:deletecoursecustomfield')
    ));

    $ADMIN->add('courses', new admin_externalpage('customicons', new lang_string('customicons', 'corplms_core'), $CFG->wwwroot . '/corplms/core/manage_customicons.php',
    ...
    $temp->add(new admin_setting_configselect('moodlecourse/visiblelearning', new lang_string('audiencevisibility', 'corplms_cohort'), new lang_string('configaudiencevisibility', 'corplms_cohort'), 2, $COHORT_VISIBILITY));
