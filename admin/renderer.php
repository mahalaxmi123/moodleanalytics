...
class core_admin_renderer extends plugin_renderer_base {
    ...
    public function install_licence_page() {
        ...
        $output .= $this->header();
        $output .= $this->heading('<a href="http://corplms.ballisticlearning.com/"> Corplms</a> -  Corplms Learning Management System', 2, 'centered');
    ...
    public function install_environment_page($maturity, $envstatus, $environment_results, $release) {
        ...
        $output .= $this->heading(" Corplms {$CORPLMS->release} : Based on Moodle {$CFG->target_release}");
    ...
    public function admin_notifications_page($maturity, $insecuredataroot, $errorsdisplayed,
            ...
            $buggyiconvnomb, $registered, array $cachewarnings = array(), $latesterror, $activeusers, $corplms_release) {
        global $CFG, $PAGE;
        $output = '';
        ...
        $output .= $corplms_renderer->is_registered();

        if ($latesterror) {
            $output .= $corplms_renderer->corplms_print_errorlog_link($latesterror);
        }
        // list count of active users
        $output .= $corplms_renderer->corplms_print_active_users($activeusers);
        /// Display  Corplms version information
        $output .= $corplms_renderer->corplms_print_copyright($corplms_release);
        //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function environment_check_page($versions, $version, $envstatus, $environment_results) {
        ...
        $select->label = get_string('corplmsversion', 'corplms_core');
    ...
    protected function maturity_info($maturity) {
        ...
        //connit by alok to hide maturity info at notification page
    ...
    protected function release_notes_link() {
        global $CFG;
        $releasenoteslink = get_string('releasenoteslink', 'admin', 'http://community.corplmslms.com/mod/forum/view.php?id=1834');
