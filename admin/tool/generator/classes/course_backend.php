...
class tool_generator_course_backend extends tool_generator_backend {
    ...
    protected function set_customs_generators() {
        $this->hierarchy_generator = $this->generator->get_plugin_generator('corplms_hierarchy');
        $this->cohort_generator = $this->generator->get_plugin_generator('corplms_cohort');
        $this->program_generator = $this->generator->get_plugin_generator('corplms_program');
        $this->completion_generator = $this->generator->get_plugin_generator('core_completion');
    }

    /**
     * Create Corplms objects, such as: audiences, positions, organisations, managers,
     * assign primary position to students, create programs, etc.
     *
     */
    protected function create_corplms_objects() {
        // Set custom data generators.
