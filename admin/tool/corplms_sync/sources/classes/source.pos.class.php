...
abstract class corplms_sync_source_pos extends corplms_sync_source {
    ...
    function __construct() {
        $this->temptablename = 'corplms_sync_pos';
        parent::__construct();
    }
    ...
    function config_form(&$mform) {
        ...
        $mform->addElement('header', 'dbfieldmappings', get_string('fieldmappings', 'tool_corplms_sync'));
