...
class corplms_sync_source_org_database extends corplms_sync_source_org {
    ...
    function import_data($temptable) {
        ...
        foreach ($fields as $field) {
            try {
                ...
                $this->addlog(get_string('dbmissingcolumnx', 'tool_corplms_sync', $field), 'error', 'importdata');
                return false;
            }
        }
