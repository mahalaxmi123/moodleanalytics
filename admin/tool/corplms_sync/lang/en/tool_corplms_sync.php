 ...
 */
$string['pluginname'] = 'Corplms sync';

$string['sync'] = 'Sync';
$string['corplmssync'] = 'Corplms sync';
$string['corplmssync_help'] = 'Enabling Corplms syncing will cause the element to be updated/deleted (synced) from an external source (if configured). The idnumber field MUST have a value to enable this field.
See the Sync settings in the Administration menu.';
$string['corplms_sync:manage'] = 'Manage Corplms sync';
$string['corplms_sync:runsync'] = 'Run Corplms sync via the web interface';
$string['corplms_sync:setfileaccess'] = 'Set Corplms sync file access';
$string['corplms_sync:manageuser'] = 'Manage Corplms sync users';
$string['corplms_sync:manageorg'] = 'Manage Corplms sync organisations';
$string['corplms_sync:managepos'] = 'Manage Corplms sync positions';
$string['corplms_sync:uploaduser'] = 'Upload Corplms sync users';
$string['corplms_sync:uploadorg'] = 'Upload Corplms sync organisations';
$string['corplms_sync:uploadpos'] = 'Upload Corplms sync positions';
$string['corplms_sync:deletesynclog'] = 'Clear the sync logs';
...
$string['uploadaccessdenied'] = 'Your Corplms Sync configuration is set to look for files in a server directory, not to use uploaded files. To change this go {$a}';
...
// Hierarchy items
$string['displayname:corplms_sync_source_org_csv'] = 'CSV';
$string['displayname:corplms_sync_source_org_database'] = 'External Database';
$string['displayname:corplms_sync_source_pos_csv'] = 'CSV';
$string['displayname:corplms_sync_source_pos_database'] = 'External Database';
$string['settings:corplms_sync_source_org_csv'] = 'Organisation - CSV source settings';
$string['settings:corplms_sync_source_org_database'] = 'Organisation - external database source settings';
$string['settings:corplms_sync_source_pos_csv'] = 'Position - CSV source settings';
$string['settings:corplms_sync_source_pos_database'] = 'Position - external database source settings';

// User
$string['displayname:corplms_sync_source_user_csv'] = 'CSV';
$string['displayname:corplms_sync_source_user_database'] = 'External Database';
$string['settings:corplms_sync_source_user_csv'] = 'User - CSV source settings';
$string['settings:corplms_sync_source_user_database'] = 'User - external database source settings';
...
$string['runsynccronstart'] = 'Running corplms_sync cron...';
...
$string['deleteallsynclogcheck'] = 'Are you absolutely sure you want to delete all the Corplms Sync log records?';
$string['deletepartialsynclogcheck'] = 'Are you absolutely sure you want to delete all the Corplms Sync log records except for the most recent run?';
$string['error:deletesynclogpermission'] = 'You do not have permission to delete sync log records!';

///
/// Corplms sync log reports
///
$string['synclog'] = 'Sync log';
$string['viewsynclog'] = 'View the results in the Sync Log <a href=\'{$a}\'>here</a>';
$string['sourcetitle'] = 'Corplms Sync Log';
...
$string['notifymessagestart'] = '{$a->count} new Corplms sync log messages ({$a->logtypes}) since {$a->since}. See below for most recent messages:';
$string['notifysubject'] = '{$a} :: Corplms sync notification';
$string['syncnotifications'] = 'Corplms sync notifications';
