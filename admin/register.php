<?php  // $Id$
    ...
    admin_externalpage_setup('corplmsregistration');
...
/// Print the form
    ...
    if (!empty($statusmsg)) {
        ...
        corplms_set_notification($statusmsg, $url, array('class'=>'notifysuccess'));
    }

/// Print headings
    echo $OUTPUT->header();

    echo $OUTPUT->heading(get_string("corplmsregistration", 'corplms_core'), 3, 'main');

    echo $OUTPUT->box(get_string("corplmsregistrationinfo", 'corplms_core'));
