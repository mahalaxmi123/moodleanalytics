...
class register_form extends moodleform {
    function definition (){
        ...
        $mform->addElement('header', 'settingsheader', get_string('corplmsregistration', 'corplms_core'));
        $radioarray=array();
        ...
        foreach ($data as $key => $value) {
            $module = (strpos($key, 'corplms') === 0 || ($key == 'debugstatus') || ($key == 'edition')) ? 'corplms_core' : 'admin';
