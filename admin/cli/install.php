...
$help =
"Command line Corplms installer, creates config.php and initializes database.
...
--wwwroot=URL         Web address for the Corplms site,
...
--dbname=NAME         Database name. Default is corplmsdb
...
if (version_compare(phpversion(), "5.4.4") < 0) {
    ...
    fwrite(STDERR, "Corplms 2.7 or later requires at least PHP 5.4.4 (currently using version $phpversion).\n");
    fwrite(STDERR, "Please upgrade your server software or install older Corplms version.\n");
    exit(1);
}
...
//Print header
echo get_string('cliinstallheader', 'install', $CORPLMS->release)."\n";
