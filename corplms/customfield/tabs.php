...
$row[] = new tabobject('course', new moodle_url('/corplms/customfield/index.php', array('prefix' => 'course')),
        get_string('courses'));
if (corplms_feature_visible('programs') || corplms_feature_visible('certifications')) {
    $row[] = new tabobject('program', new moodle_url('/corplms/customfield/index.php', array('prefix' => 'program')),
        get_string('programscerts', 'corplms_program'));
}
