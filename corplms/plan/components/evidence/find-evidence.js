 ...
 * @subpackage plan
 */
M.corplms_plan_find_evidence = M.corplms_plan_find_evidence || {
    ...
    init: function(Y, args){
        ...
        var url = M.cfg.wwwroot + '/corplms/plan/components/'+this.config.component_name+'/';
        var evidenceurl = M.cfg.wwwroot + '/corplms/plan/components/evidence/';
        ...
        corplmsDialogs['evidence'] = new corplmsDialog(
            ...
            {
                buttons: buttonsObj,
                title: '<h2>' + M.util.get_string('addlinkedevidence', 'corplms_plan') + '</h2>'
            },
