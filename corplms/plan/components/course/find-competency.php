...
require_once($CFG->dirroot.'/corplms/plan/components/competency/dialog_content_linked_competencies.class.php');
...
$dialog = new corplms_dialog_linked_competencies_content_competencies();
