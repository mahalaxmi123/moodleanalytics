...
require_once($CFG->dirroot.'/corplms/plan/components/course/course.class.php');
...
function dp_course_component_build_settings_form(&$mform, $customdata) {
    ...
    $mform->addElement('header', 'coursesettings', get_string('coursesettings', 'corplms_plan'));
    $mform->addHelpButton('coursesettings', 'advancedsettingscoursesettings', 'corplms_plan', '', true);
    ...
    $mform->addElement('header', 'coursepermissions', get_string('coursepermissions', 'corplms_plan'));
    $mform->addHelpButton('coursepermissions', 'advancedsettingscoursepermissions', 'corplms_plan', '', true);
...
function dp_course_component_process_settings_form($fromform, $id) {
    ...
    $currenturl = new moodle_url('/corplms/plan/template/advancedworkflow.php', array('id' => $id, 'component' => 'course'));
        ...
        corplms_set_notification(get_string('update_course_settings', 'corplms_plan'), $currenturl, array('class' => 'notifysuccess'));
}
