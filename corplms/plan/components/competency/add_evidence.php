...
if ($component->get_setting('setproficiency') != DP_PERMISSION_ALLOW) {
    print_error('error:competencystatuspermission', 'corplms_plan');
}
...
$mform = new corplms_competency_evidence_form(null, compact('id','evidenceid','competencyid','positionid',
...
if ($fromform = $mform->get_data()) { // Form submitted
    if (empty($fromform->submitbutton)) {
        print_error('error:unknownbuttonclicked', 'corplms_core', $returnurl);
    }
    ...
    if ($result) {
        ...
        redirect($returnurl, get_string('recordnotcreated', 'corplms_core'));
    }
...
$fullname = get_string('setcompetencystatus', 'corplms_plan');
