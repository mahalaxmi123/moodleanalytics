 ...
 */
M.corplms_plan_competency_find = M.corplms_plan_competency_find || {
    ...
    corplmsDialog_handler_lpCompetency: null,
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_plan_competency_find.init()-> jQuery dependency required for this module to function.');
        }

        // Create handler for the dialog
        this.corplmsDialog_handler_lpCompetency = function() {
            // Base url
            var baseurl = '';
        }

        this.corplmsDialog_handler_lpCompetency.prototype = new M.corplms_plan_component.corplmsDialog_handler_preRequisite();
         ...
         * @return  void
         */
        this.corplmsDialog_handler_lpCompetency.prototype._open = function() {
         ...
         * @return  void
         */
        this.corplmsDialog_handler_lpCompetency.prototype._continue = function(url) {
         ...
         * @return  void
         */
        this.corplmsDialog_handler_lpCompetency.prototype._continueRender = function(response) {
         ...
         * @return void
         */
        corplmsDialog_handler.prototype._continueSave = function(url) {
        ...
        var handler = new this.corplmsDialog_handler_lpCompetency();
        handler.baseurl = url;
        ...
        handler.standard_buttons[M.util.get_string('save', 'corplms_core')] = function() { handler._save(saveurl) }
        ...
        handler.continuesave_buttons[M.util.get_string('save', 'corplms_core')] = function() { handler._continueSave(continuesaveurl) }
        ...
        corplmsDialogs['evidence'] = new corplmsDialog(
            ...
            {
                buttons: {},
                title: '<h2>' + M.util.get_string('addcompetencys', 'corplms_plan') + '</h2>'
            },
