...
$currenturl = new moodle_url('/corplms/plan/components/competency/approval.php', array('id' => $id, 'itemid' => $caid, 'action' => $action));
...
if ($confirm) {
    ...
    if (!$canapprovecompetency) {
        ...
        print_error('nopermission', 'corplms_plan', $returnurl);
    }
