...
require_once($CFG->dirroot.'/corplms/plan/components/course/dialog_content_linked_courses.class.php');
...
$dialog = new corplms_dialog_linked_courses_content_courses();
