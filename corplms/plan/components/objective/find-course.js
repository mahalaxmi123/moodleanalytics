 ...
 */
M.corplms_plan_objective_find_course = M.corplms_plan_objective_find_course || {
 ...
 // public handler reference for the dialog
    ...
    init: function(Y, args){
        ...
        corplmsDialog_handler_preRequisite = function() {
            // Base url
            var baseurl = '';
        }

        corplmsDialog_handler_preRequisite.prototype = new corplmsDialog_handler_treeview_multiselect();
         ...
         * @return void
         */
        corplmsDialog_handler_preRequisite.prototype._update = function(response) {
        ...
        var url = M.cfg.wwwroot + '/corplms/plan/components/objective/';
        var saveurl = url + 'update-course.php?planid='+this.config.plan_id+'&objectiveid='+this.config.objective_id+'&update=';

        var handler = new corplmsDialog_handler_preRequisite();
        handler.baseurl = url;
        var buttonsObj = {};
