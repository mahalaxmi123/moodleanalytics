...
require_once($CFG->dirroot.'/corplms/plan/components/program/program.class.php');
...
function dp_program_component_build_settings_form(&$mform, $customdata) {
    ...
    $mform->addElement('header', 'programsettings', get_string('programsettings', 'corplms_plan'));
    $mform->addHelpButton('programsettings', 'advancedsettingsprogramsettings', 'corplms_plan', '', true);
    ...
    $mform->addElement('header', 'programpermissions', get_string('programpermissions', 'corplms_plan'));
    $mform->addHelpButton('programpermissions', 'advancedsettingsprogrampermissions', 'corplms_plan', '', true);
...
function dp_program_component_process_settings_form($fromform, $id) {
    ...
    $currenturl = new moodle_url('/corplms/plan/template/advancedworkflow.php', array('id' => $id, 'component' => 'program'));
        ...
        corplms_set_notification(get_string('update_program_settings', 'corplms_plan'), $currenturl, array('class' => 'notifysuccess'));
}
