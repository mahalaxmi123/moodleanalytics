 ...
 */
M.corplms_plan_program_find = M.corplms_plan_program_find || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_plan_program_find.init()-> jQuery dependency required for this module to function.');
        }

        var url = M.cfg.wwwroot + '/corplms/plan/components/program/';
        ...
        corplmsDialogs['evidence'] = new corplmsDialog(
            ...
            {
                buttons: buttonsObj,
                title: '<h2>' + M.util.get_string('addprograms', 'corplms_plan') + '</h2>'
            },
