...
class plan_reactivate_form extends moodleform {
    function definition() {
        ...
        $mform->addElement('static', 'reactivatecheck', null, get_string('checkplanreactivate', 'corplms_plan', $plan->name));
        ...
        $this->add_action_buttons(true, get_string('reactivate', 'corplms_plan'));
    }
    ...
    function validation($data, $files) {
        ...
        if (!empty($data['validate_date'])) {
            ...
            if ($datenow > $enddate && $enddate !== false) {
                ...
                $errstr = get_string('error:reactivatedatebeforenow', 'corplms_plan');
