...
$PAGE->set_url(new moodle_url('/corplms/plan/record/programs_recurring.php',
...
if ($USER->id != $userid) {
    ...
    $strheading = get_string('recurringprogramhistoryfor', 'corplms_program', $a);
    $menuitem = 'myteam';
    $url = new moodle_url('/my/teammembers.php');
} else {
    $strheading = get_string('recurringprogramhistory', 'corplms_program', format_string($program->fullname));
    $menuitem = 'mylearning';
    $url = new moodle_url('/my/');
}
// Get subheading name for display.
$strsubheading = get_string('recurringprograms', 'corplms_program');
