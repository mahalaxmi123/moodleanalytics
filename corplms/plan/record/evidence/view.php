...
$PAGE->set_url('/corplms/plan/record/evidence/view.php', array('id' => $evidenceid));

if ($USER->id != $userid && !corplms_is_manager($userid) && !has_capability('corplms/plan:accessanyplan', context_system::instance())) {
...
$indexurl = new moodle_url('/corplms/plan/record/index.php', array('userid' => $userid));
$PAGE->navbar->add($strheading, $indexurl);
$PAGE->navbar->add(get_string('allevidence', 'corplms_plan'));
