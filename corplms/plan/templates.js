...
M.corplms_plan_template = M.corplms_plan_template || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_plan_template.init()-> jQuery dependency required for this module to function.');
        }

        var templates = M.corplms_plan_template.config.templates;
        ...
        $(function() {
            ...
            $('select#id_templateid').change(function() {
                ...
                var datestr = $.datepicker.formatDate(M.util.get_string('datepickerlongyeardisplayformat', 'corplms_core'), date);
