...
function development_plan_build_settings_form(&$mform, $customdata) {
    ...
    //Settings
    $mform->addElement('header', 'plansettings', get_string('plansettings', 'corplms_plan'));
    $mform->addHelpButton('plansettings', 'advancedsettingsplansettings', 'corplms_plan', '', true);
    ...
    $plancompletiongroup[] =& $mform->createElement('advcheckbox', 'manualcomplete', null, get_string('manualcomplete', 'corplms_plan'));
    $plancompletiongroup[] =& $mform->createElement('advcheckbox', 'autobyitems', null, get_string('autobyitems', 'corplms_plan'));
    $plancompletiongroup[] =& $mform->createElement('advcheckbox', 'autobyplandate', null, get_string('autobyplandate', 'corplms_plan'));

    $mform->addGroup($plancompletiongroup, 'plancomplete', get_string('planmarkedcomplete', 'corplms_plan'), array(html_writer::empty_tag('br')), false);
    ...
    //Permissions
    $mform->addElement('header', 'planpermissions', get_string('planpermissions', 'corplms_plan'));
    $mform->addHelpButton('planpermissions', 'advancedsettingsplanpermissions', 'corplms_plan', '', true);
...
function development_plan_process_settings_form($fromform, $id) {
    ...
    $currenturl = new moodle_url('/corplms/plan/template/advancedworkflow.php', array('id' => $id, 'component' => 'plan'));
    ...
    corplms_set_notification(get_string('update_plan_settings', 'corplms_plan'), $currenturl, array('class' => 'notifysuccess'));
}
