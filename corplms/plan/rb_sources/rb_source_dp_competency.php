    ...
    public function rb_display_proficiency_and_approval_menu($status, $row) {
        ...
        if (!$planid) {
            ...
            if ($competencycomponent->can_update_competency_evidence($row)) {
                ...
                $action = "var response; ".
                          "response = \$.get(".
                              "'{$CFG->wwwroot}/corplms/plan/components/competency/update-competency-setting.php".
                ...
                $content[] = html_writer::select($compscale,
                                              ...
                                              $compevscalevalueid,
                                              array(($compevscalevalueid ? '' : 0) => ($compevscalevalueid ? '' : get_string('notset', 'corplms_hierarchy'))),
                                              $attributes);
            } else if ($status) {
                $content[] = $status;
            }
