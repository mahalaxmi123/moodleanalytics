 ...
 */
function xmldb_corplms_plan_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2013021400) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013021400, 'corplms_plan');
    }
    ...
    if ($oldversion < 2013040200) {
        ...
        upgrade_plugin_savepoint(true, 2013040200, 'corplms', 'plan');
    }
    ...
    if ($oldversion < 2013040201) {
        ...
        upgrade_plugin_savepoint(true, 2013040201, 'corplms', 'plan');
    }
    ...
    if ($oldversion < 2013103000) {
        ...
        // Plan savepoint reached.
        upgrade_plugin_savepoint(true, 2013103000, 'corplms', 'plan');
    }
    ...
    if ($oldversion < 2013111500) {
        ...
        upgrade_plugin_savepoint(true, 2013111500, 'corplms', 'plan');
    }
    ...
    if ($oldversion < 2014030600) {
        ...
        upgrade_plugin_savepoint(true, 2014030600, 'corplms', 'plan');
    }
    ...
    if ($oldversion < 2014082200) {
        ...
        // Plan savepoint reached.
        upgrade_plugin_savepoint(true, 2014082200, 'corplms', 'plan');
    }
