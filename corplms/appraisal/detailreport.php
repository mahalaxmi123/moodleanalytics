...
$url = new moodle_url('/corplms/appraisal/detailreport.php', array('format' => $format, 'debug' => $debug));
...
$heading = get_string('detailreportforx', 'corplms_appraisal', $appraisal->name);
