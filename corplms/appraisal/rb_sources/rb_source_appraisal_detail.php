...
class rb_source_appraisal_detail extends rb_source_appraisal {
    ...
    public function post_params(reportbuilder $report) {
        ...
        $this->set_redirect(new moodle_url('/corplms/appraisal/rb_sources/appraisaldetailselector.php',
                array('detailreportid' => $report->_id)),
                get_string('selectappraisal', 'corplms_appraisal'));
    ...
    public function rb_cols_generator_totals($columnoption, $hidden) {
        ...
        $rolename = get_string($columnoption->type, 'corplms_appraisal');
    ...
    private function get_columns_for_question($question, $columnoption, $hidden, $includesummary = true) {
        ...
        $rolename = get_string($role, 'corplms_appraisal');
        $a = new stdClass();
                    ...
                    new rb_join(
                        ...
                        "(SELECT f.itemid AS appraisalroleassignmentid, " . sql_group_concat($file) . " AS files " .
                          ...
                          "WHERE f.contextid = {$FILEPICKER_OPTIONS['context']->id} " .
                            "AND f.component = 'corplms_appraisal' " .
    ...
    public function get_required_jss() {
        ...
        $jsdetails->initcall = 'M.corplms_reportbuilder_verticaltableheadings.init';
        $jsdetails->jsmodule = array('name' => 'corplms_reportbuilder_verticaltableheadings',
            'fullpath' => '/corplms/reportbuilder/js/verticaltableheadings.js');
