...
$url = new moodle_url('/corplms/appraisal/statusreport.php', array('format' => $format, 'debug' => $debug));
...
if (!$appraisalid) {
    echo $OUTPUT->header();
    $overviewurl = new moodle_url('/corplms/appraisal/reports.php');
...
$heading = get_string('statusreportforx', 'corplms_appraisal', $appraisal->name);
