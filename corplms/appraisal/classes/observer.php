...
class corplms_appraisal_observer {
     ...
     *
     * @param \corplms_appraisal\event\appraisal_activation $event
     */
    public static function appraisal_activation(\corplms_appraisal\event\appraisal_activation $event) {
        global $DB, $CFG;

        require_once($CFG->dirroot . '/corplms/appraisal/lib.php'); // We should move all the classes into self loading ones.
     ...
     *
     * @param \corplms_appraisal\event\appraisal_stage_completion $event
     */
    public static function appraisal_stage_completion(\corplms_appraisal\event\appraisal_stage_completion $event) {
        global $DB, $CFG;
