...
$capabilities = array(
    ...
    'corplms/appraisal:manageappraisals' => array(
    ...
    'corplms/appraisal:cloneappraisal' => array(
    'riskbitmask'   => RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'corplms/appraisal:assignappraisaltogroup' => array(
    'riskbitmask'   => RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'corplms/appraisal:viewassignedusers' => array(
    ...
    'corplms/appraisal:managenotifications' => array(
    ...
    'corplms/appraisal:manageactivation' => array(
    'riskbitmask'   => RISK_SPAM | RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'corplms/appraisal:managepageelements' => array(
    ...
    'corplms/appraisal:printstaffappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
    ...
    'corplms/appraisal:viewownappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'corplms/appraisal:printownappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
