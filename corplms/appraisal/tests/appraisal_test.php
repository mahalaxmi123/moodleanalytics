 ...
 *
 * Unit tests for appraisal class of corplms/appraisal/lib.php
 */
global $CFG;
require_once($CFG->dirroot.'/corplms/appraisal/tests/appraisal_testcase.php');
...
class appraisal_test extends appraisal_testcase {
    ...
    public function test_appraisal_activate() {
        ...
        $assign2 = new corplms_assign_appraisal('appraisal', $appraisal1);
    ...
    public function test_active_appraisal_add_group () {
        ...
        $assign = new corplms_assign_appraisal('appraisal', $appraisal);
