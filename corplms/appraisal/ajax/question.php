...
require_capability('corplms/appraisal:managepageelements', $sytemcontext);
...
$returnurl = new moodle_url('/corplms/appraisal/ajax/question.php', array('appraisalstagepageid' => $pageid));
        ...
        switch (required_param('type', PARAM_ALPHA)) {
            ...
            case 'stage':
                ...
                if (empty($page)) {
                    ...
                    $page->name = get_string('temporarypage', 'corplms_appraisal');
