...
class programs extends \corplms_core\corplms\menu\item {

    protected function get_default_title() {
        return get_string('programs', 'corplms_coursecatalog');
    }
    ...
    protected function get_default_url() {
        ...
        if (!empty($CFG->enhancedcatalog)) {
            return '/corplms/coursecatalog/programs.php';
        } else {
            return '/corplms/program/index.php';
        }
    }
