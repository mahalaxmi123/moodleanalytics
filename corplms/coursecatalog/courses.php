...
$PAGE->set_corplms_menu_selected('course');
$PAGE->set_url('/corplms/coursecatalog/courses.php');
...
$strheading = get_string('searchcourses', 'corplms_core');
...
$PAGE->navbar->add($fullname, new moodle_url("/corplms/coursecatalog/courses.php"));
