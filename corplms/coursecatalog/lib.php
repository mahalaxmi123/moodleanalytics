 ...
 *
 * @package corplms
 * @subpackage corplms_coursecatalog
 */
 ...
 */
function corplms_get_category_item_count($categoryids, $viewtype = 'course') {
    global $CFG, $USER, $DB;
 ...
 */
function corplms_course_cmp_by_count($a, $b) {
 ...
 * @return bool
 */
function corplms_course_is_viewable($courseid, $userid = null) {
    global $USER, $CFG, $DB;
    require_once($CFG->dirroot . '/corplms/cohort/lib.php');
 ...
 */
function corplms_get_style_visibility($component, $oldvisfield = 'visible', $audvisfield = 'audiencevisible') {
    global $CFG;
    $dimmed = '';
 ...
 */
function corplms_visibility_where($userid = null, $fieldbaseid = 'course.id', $fieldvisible = 'course.visible',
    ...
    if (is_siteadmin($userid)) {
        ...
        $canmanagevisibility = has_capability('corplms/coursecatalog:manageaudiencevisibility', $systemcontext, $userid);
