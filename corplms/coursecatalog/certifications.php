...
$PAGE->set_corplms_menu_selected('certification');
$PAGE->set_pagelayout('noblocks');
$PAGE->set_url('/corplms/coursecatalog/certifications.php');
if ($CFG->forcelogin) {
    require_login();
}
...
$strheading = get_string('searchcertifications', 'corplms_certification');
...
$fullname = get_string('certifications', 'corplms_certification');
$pagetitle = format_string(get_string('findlearning', 'corplms_core') . ': ' . $fullname);

$PAGE->navbar->add($fullname, new moodle_url('/corplms/coursecatalog/certifications.php'));
