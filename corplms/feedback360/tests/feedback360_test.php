...
global $CFG;
require_once($CFG->dirroot.'/corplms/feedback360/tests/feedback360_testcase.php');
...
class feedback360_test extends feedback360_testcase {
    ...
    public function test_activate() {
        ...
        $assign = new corplms_assign_feedback360('feedback360', $fdbcktest);
    ...
    public function test_duplicate() {
        ...
        $assign = new corplms_assign_feedback360('feedback360', $newfdbck);
