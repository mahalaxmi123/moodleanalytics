 ...
 */
M.corplms_feedback360_content = M.corplms_feedback360_content || {
  ...
  init : function(Y, args) {
    ...
    if ( typeof $ === 'undefined') {
      throw new Error('M.corplms_feedback360_content.init()-> jQuery dependency required for this module to function.');
    }
    makeDraggable(M.cfg.wwwroot + '/corplms/feedback360/content.php', '#feedback360-quest-list', 'li');
