...
$success_str = get_string('successfullyrequestedfeedback', 'corplms_feedback360');
$redirectto = new moodle_url('/corplms/feedback360/index.php');
corplms_set_notification($success_str, $redirectto, array('class' => 'notifysuccess'));
