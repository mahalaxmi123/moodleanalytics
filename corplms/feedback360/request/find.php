...
$availableusers = $DB->get_records_sql(
   "
        ...
        ORDER BY
            ...
            u.lastname
    ",
    $params, 0, CORPLMS_DIALOG_MAXITEMS + 1);
...
if (!$nojs) {
    ...
    $PAGE->set_url(new moodle_url('/corplms/feedback360/request/find.php',
    ...
    if (optional_param('cancel', false, PARAM_BOOL) && confirm_sesskey()) {
        ...
        $request_url = '/corplms/feedback360/request.php';
    ...
    if (optional_param('add', false, PARAM_BOOL) && confirm_sesskey()) {
        ...
        $url = new moodle_url('/corplms/feedback360/request/find.php',
