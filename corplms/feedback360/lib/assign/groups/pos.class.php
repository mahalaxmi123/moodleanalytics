...
require_once($CFG->dirroot.'/corplms/core/lib/assign/groups/pos.class.php');
require_once($CFG->dirroot.'/corplms/hierarchy/prefix/position/lib.php');

class corplms_assign_feedback360_grouptype_pos extends corplms_assign_core_grouptype_pos {
