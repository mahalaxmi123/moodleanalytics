 ...
 */
/**
 * Classes to help in generating the $eventdata needed to send corplms messages
 */

defined('MOODLE_INTERNAL') || die();

/**
 * A basic corplms message
 */
...
/**
 * A corplms "task" (a message which prompts the user to make an accept/reject choice)
 */
...
/**
 * A corplms "alert" (message which requires no response)
 */
