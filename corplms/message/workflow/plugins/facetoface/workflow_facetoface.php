...
*/
class corplms_message_workflow_facetoface extends corplms_message_workflow_plugin_base {
    ...
    private function acceptreject_notification($userid, $facetoface, $session, $langkey) {
        ...
        $newevent->urgency     = CORPLMS_MSG_URGENCY_NORMAL;
        $newevent->icon        = 'facetoface-regular';
        $newevent->msgtype     = CORPLMS_MSG_TYPE_FACE2FACE;
