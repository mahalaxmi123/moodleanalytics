...
class rb_source_corplmsmessages extends rb_base_source {
    ...
    function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle', 'rb_source_corplmsmessages');
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
            new rb_column_option(
                'message_values',
                'subject',
                get_string('subject', 'rb_source_corplmsmessages'),
                'msg.subject',
                array('joins' => 'msg',
                      'dbdatatype' => 'text',
                      'outputformat' => 'text')
            ...
            new rb_column_option(
                'message_values',
                'statement',
                get_string('statement', 'rb_source_corplmsmessages'),
                'msg.fullmessagehtml',
                array('joins' => 'msg',
                      'dbdatatype' => 'text',
                      'outputformat' => 'text')
            ...
            new rb_column_option(
                'message_values',
                'urgency',
                get_string('msgurgencyicon', 'rb_source_corplmsmessages'),
                'base.urgency',
                array(
                    'defaultheading' => get_string('msgurgency', 'rb_source_corplmsmessages'),
            ...
            new rb_column_option(
                'message_values',
                'urgency_text',
                get_string('msgurgency', 'rb_source_corplmsmessages'),
                'base.urgency',
            ...
            new rb_column_option(
                'message_values',
                'msgtype',
                get_string('msgtype', 'rb_source_corplmsmessages'),
                'base.msgtype',
                array(
                    'joins' => array('msg'),
            ...
            new rb_column_option(
                'message_values',
                'msgtype_text',
                get_string('msgtypetext', 'rb_source_corplmsmessages'),
                'base.msgtype',
                array(
                    'defaultheading' => get_string('msgtype', 'rb_source_corplmsmessages'),
            ...
            new rb_column_option(
                'message_values',
                'category',
                get_string('msgcategory', 'rb_source_corplmsmessages'),
            ...
            new rb_column_option(
                'message_values',
                'sent',
                get_string('sent', 'rb_source_corplmsmessages'),
                'msg.timecreated',
                array('joins' => 'msg',
            ...
            new rb_column_option(
                'message_values',
                'checkbox',
                get_string('select', 'rb_source_corplmsmessages'),
                'base.messageid',
            ...
            new rb_column_option(
                'message_values',
                'msgid',
                get_string('msgid', 'rb_source_corplmsmessages'),
                'base.messageid',
                array('nosort' => true,
                      'noexport' => true,
                      'hidden' => 1,
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'message_values',       // type
                'sent',                 // value
                get_string('datesent', 'rb_source_corplmsmessages'),            // label
                'date',                 // filtertype
                array()                 // options
            ),
            new rb_filter_option(
    ...
    protected function define_requiredcolumns() {
        $requiredcolumns = array(
            new rb_column(
                'message_values',
                'dismiss_link',
                get_string('dismissmsg', 'rb_source_corplmsmessages'),
                'base.messageid',
    ...
    function rb_display_urgency_link($comp, $row, $export = 0) {
        global $OUTPUT;
        $display = corplms_message_urgency_text($row->message_values_urgency);
        if ($export) {
            return $display['text'];
        }
    ...
    function rb_display_urgency_text($urgency, $row) {
        $display = corplms_message_urgency_text($urgency);
        return $display['text'];
    }
    ...
    function rb_display_msgtype_link($comp, $row, $export = 0) {
        ...
        return $OUTPUT->pix_icon("/msgicons/" . $icon, $subject, 'corplms_core', array('title' => $subject));
    }

    // generate status type text
    function rb_display_msgtype_text($msgtype, $row) {
        $display = corplms_message_msgtype_text($msgtype);
        return $display['text'];
    }
    ...
    function rb_display_msgcategory_text($comp, $row) {
        ...
        if ($comp != '' && in_array($comp, $CORPLMS_MESSAGE_CATEGORIES)) {
            return get_string($comp, 'corplms_message');
        }
        return $comp;
    }
    ...
    function rb_display_dismiss_link($id, $row) {
        $out = corplms_message_dismiss_action($id);
        $out .= html_writer::checkbox('corplms_message_' . $id, $id, false, '', array('id' => 'corplms_msgcbox_'.$id, 'class' => "selectbox"));
    ...
    function rb_display_task_links($id, $row) {
        $out = corplms_message_accept_reject_action($id);
        $out .= corplms_message_dismiss_action($id);
    ...
    function rb_display_message_checkbox($id, $row) {
        return html_writer::checkbox('corplms_message_' . $id, $id, false, '', array('id' => 'corplms_message', 'class' => "selectbox"));
    }
    ...
    function rb_filter_message_urgency_list() {
        ...
        $urgencyselect = array();
        $urgencyselect[CORPLMS_MSG_URGENCY_NORMAL] = get_string('urgencynormal', 'corplms_message');
        $urgencyselect[CORPLMS_MSG_URGENCY_URGENT] = get_string('urgencyurgent', 'corplms_message');
    ...
    function rb_filter_message_type_list() {
        ...
        foreach (array('competency', 'course', 'evidence',
            ...
            $typename = get_string($type, 'corplms_message');
            $out[$type] = $OUTPUT->pix_icon('/msgicons/' . $type . '-regular', $typename, 'corplms_core') . '&nbsp;' . $typename;
        }
