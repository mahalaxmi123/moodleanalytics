...
global $CFG;
require_once($CFG->dirroot.'/corplms/question/tests/question_testcase.php');
require_once($CFG->dirroot.'/corplms/question/field/text.class.php');

class question_storage_test extends corplms_question_testcase {
