...
class corplms_assign_core_grouptype_cohort extends corplms_assign_core_grouptype {

    protected $grouptype = 'cohort';
    // The dialog class.
    protected $pickerclass = 'corplms_assign_ui_picker_cohort';
    ...
    public function get_grouptype_displayname() {
        return get_string($this->grouptype, 'corplms_cohort');
    }
