...
class corplms_assign_core_grouptype_hierarchy extends corplms_assign_core_grouptype {

    // The dialog class.
    protected $pickerclass = 'corplms_assign_ui_picker_hierarchy';
    ...
    public function get_grouptype_displayname() {
        return get_string($this->prefix, 'corplms_hierarchy');
    }
