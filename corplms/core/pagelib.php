 ...
 */
class corplms_page extends moodle_page {
    /**
     * Return corplms requirements manager
    ...
    protected function magic_get_requires() {
        if (is_null($this->_requires)) {
            $this->_requires = new corplms_page_requirements_manager();
        }
 ...
 */
class corplms_page_requirements_manager extends page_requirements_manager {
    /**
