 ...
 *
 * corplms_core specific language strings.
 * these should be called like get_string('key', 'corplms_core');
 */
...
$string['cannotdownloadcorplmslanguageupdatelist'] = 'Cannot download list of language updates from download.corplmslms.com';
...
$string['configforcelogincorplms'] = 'Normally, the entire site is only available to logged in users. If you would like to make the front page and the course listings (but not the course contents) available without logging in, then you should uncheck this setting.';
...
$string['csvdateformatconfig'] = 'Date format to be used in CSV imports like user uploads with date custom profile fields, or Corplms Sync.
...
$string['enabledisablecorplmssync'] = 'Select Enable or Disable and then click continue to update Corplms Sync for {$a}';
...
$string['error:autoupdatedisabled'] = 'Automatic checking for Moodle updates is currently disabled in Corplms';
$string['error:cannotupgradefromnewermoodle'] = 'You cannot upgrade to Corplms {$a->newcorplmsversion} from this version of Moodle. Please use a newer version of Corplms which is based on Moodle core {$a->oldversion} or above.';
$string['error:cannotupgradefrommoodle'] = 'You cannot upgrade to Corplms 2.4 from a Moodle version prior to 2.2.7. Please upgrade to Corplms 2.2.13+ or Moodle 2.2.7+ first.';
$string['error:cannotupgradefromcorplms'] = 'You cannot upgrade to Corplms 2.4 from this version of Corplms. Please upgrade to Corplms 2.2.13 or greater first.';
...
$string['error:emptyidnumberwithsync'] = 'Corplms Sync is enabled but the ID number field is empty. Either disable sync for this user or provide a valid ID number.';
...
$string['error:notificationsparamtypewrong'] = 'Incorrect param type sent to Corplms notifications';
...
$string['notimplementedcorplms'] = 'Sorry, this feature is only implemented on MySQL, MSSQL and PostgreSQL databases.';
...
$string['pluginname'] = 'Corplms core';
...
$string['poweredby'] = 'Powered by CorplmsLMS';
...
$string['remotecorplmslangnotavailable'] = 'Because Corplms can not connect to download.corplmslms.com, we are unable to do language pack installation automatically. Please download the appropriate zip file(s) from http://download.corplmslms.com/lang/T{$a->corplmsversion}/, copy them to your {$a->langdir} directory and unzip them manually.';
...
$string['seedlingsmessage'] = 'WARNING: Corplms Seedlings is a developer-only release of CorplmsLMS for testing only and is not designed for use in a production environment. For a live site you should subscribe to <a href="http://corplmslms.com/subscribe">CorplmsLMS Enterprise</a> to receive stable releases, technical support and ongoing bug fixes.';
...
$string['togglecorplmssync'] = 'Toggle Corplms sync';
$string['togglecorplmssyncerror'] = 'Could not enable/disable the corplms sync field for user {$a}';
$string['togglecorplmssyncerror:noidnumber'] = 'The ID Number field is empty and so corplms sync cannot be enabled for these users: {$a}';
$string['corplmsbuild'] = 'Corplms build number';
$string['corplmscopyright'] = '<p class="corplms-copyright"><a href="http://www.corplmslms.com">CorplmsLMS</a> is a distribution of Moodle. A "distro" or distribution is a ready-made extended version of the standard product with its own particular focus and vision. Corplms is specifically designed for the requirements of corporate, industry and vocational training in contrast to standard Moodle\'s traditional educational setting.</p><p class="corplms-copyright"><a href="http://www.corplmslms.com">CorplmsLMS</a> extensions are Copyright &copy; 2010 onwards, Corplms Learning Solutions Limited.</p>';
$string['corplmscore'] = 'Corplms core';
$string['corplmsfeatures'] = 'Corplms features';
$string['corplmslogo'] = 'Corplms Logo';
$string['corplmsmenu'] = 'Corplms Menu';
$string['corplmsnavigation'] = 'Main menu';
$string['corplmsregistration'] = 'Corplms Registration';
$string['corplmsregistrationinfo'] = '<p>This page configures registration updates which are sent to corplmslms.com.
These updates allow Corplms to know what versions of Corplmslms and support software you are running.
This information will allow Corplms to better examine and resolve any support issues you face in the future.</p>
<p>This information will be securely transmitted and held in confidence.</p>';
$string['corplmsrelease'] = 'Corplms release identifier';
$string['corplmsreleaselink'] = 'See the <a href="http://community.corplmslms.com/mod/forum/view.php?id=1834" target=\"_blank\">release notes</a> for more details.';
$string['corplmsrequiredupgradeversion'] = 'Corplms 2.2.13';
$string['corplmsuniqueidnumbercheckfail'] = 'The following tables contain non-unique values in the column idnumber:<br/><br/>
{$a}
<br/>
Please fix these records before attempting the upgrade.';
$string['corplmsunsupportedupgradepath'] = 'You cannot upgrade directly to {$a->attemptedversion} from {$a->currentversion}. Please upgrade to at least {$a->required} before attempting the upgrade to {$a->attemptedversion}.';
$string['corplmsupgradecheckduplicateidnumbers'] = 'Check duplicate ID numbers';
$string['corplmsupgradesetstandardtheme'] = 'Enable Standard Corplms theme';
$string['corplmsversion'] = 'Corplms version number';
