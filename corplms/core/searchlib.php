 ...
 */
function corplms_search_parse_keywords($query) {
    $query = trim($query);
 ...
 */
function corplms_search_get_keyword_where_clause($keywords, $fields, $type=SQL_PARAMS_QM, $prefix='param') {
    global $DB;

    $queries = array();
    $params = array();
    static $CORPLMS_SEARCH_PARAM_COUNTER = 1;
