...
class menuitem_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmenuitemcreated', 'corplms_core');
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'corplms_core', 'menu item created', "edit.php?id={$this->objectid}", $this->objectid);
    }
    ...
    public function get_url() {
        return new \moodle_url('/corplms/core/menu/edit.php', array('id' => $this->objectid));
    }
