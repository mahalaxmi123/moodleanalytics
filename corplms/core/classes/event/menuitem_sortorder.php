...
class menuitem_sortorder extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'corplms_core', 'menu item updated', "index.php?{$this->other['action']}={$this->objectid}", $this->objectid);
    }
    ...
    public function get_url() {
        return new \moodle_url('/corplms/core/menu/index.php', array($this->other['action'] => $this->objectid));
    }
