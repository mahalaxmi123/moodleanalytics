...
class menuadmin_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmenuadminviewed', 'corplms_core');
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'corplms_core', 'main menu viewed', 'index.php');
    }
    ...
    public function get_url() {
        return new \moodle_url('/corplms/core/menu/index.php');
    }
}
