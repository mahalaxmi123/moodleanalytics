...
class item {
    ...
    protected function get_default_title() {
        throw new \moodle_exception('error:menuitemtitleismissing', 'corplms_core', null, get_called_class());
    }
    ...
    protected function get_default_url() {
        throw new \moodle_exception('error:menuitemurlismissing', 'corplms_core', null, get_called_class());
    }
    ...
    public function get_default_visibility() {
        throw new \moodle_exception('error:menuitemvisibilityismissing', 'corplms_core', null, get_called_class());
    }
     ...
     * Coming string is "corplms_core\corplms\menu\myclassname".
     * Returns "myclassname".
     *
