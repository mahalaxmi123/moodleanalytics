 ...
 */
M.corplms_coursecompetency = M.corplms_coursecompetency || {
    ...
    init: function(Y, args){
        ...
        if (typeof this.config.competencyuseresourcelevelevidence !== 'undefined' &&
            ...
            corplmsDialog_handler_assignCourseEvidence = function() {
                // Base url
                var baseurl = '';
            };

            corplmsDialog_handler_assignCourseEvidence.prototype = new corplmsDialog_handler_treeview_singleselect(null, null, dualpane=true);

            corplmsDialog_handler_assignCourseEvidence.prototype.handle_click = function(clicked) {
            ...
            corplmsDialog_handler_assignCourseEvidence.prototype.display_evidence = function(response) {
            ...
            ///
            (function() {
                var url = M.cfg.wwwroot+'/corplms/hierarchy/prefix/competency/course/';

                var handler = new corplmsDialog_handler_assignCourseEvidence();
                handler.baseurl = url;

                var buttonsObj = {};
                buttonsObj[M.util.get_string('cancel','moodle')] = function() { handler._cancel() };

                corplmsDialogs['coursecompetency'] = new corplmsDialog(
                    'coursecompetency',
                    'show-coursecompetency-dialog',
                    {
                        buttons: buttonsObj,
                        title: '<h2>'+M.util.get_string('addcourseevidencetocompetencies', 'corplms_hierarchy')+'</h2>'
                    },
            ...
            corplmsDialog_handler_courseEvidence = function() {
                // Base url
                var baseurl = '';
            };

            corplmsDialog_handler_courseEvidence.prototype = new corplmsDialog_handler_treeview_multiselect();
             ...
             * @return void
             */
            corplmsDialog_handler_courseEvidence.prototype._update = function(response) {
            ...
            (function() {
                ...
                var handler = new corplmsDialog_handler_courseEvidence();
                handler.baseurl = url;
                ...
                corplmsDialogs['evidence'] = new corplmsDialog(
                    ...
                    {
                        buttons: buttonsObj,
                        title: '<h2>'+M.util.get_string('assigncoursecompletiontocompetencies', 'corplms_hierarchy')+'</h2>'
                    },
            ...
            $(corplmsDialogs.evidence.dialog).bind('ajaxComplete', function(event) {
