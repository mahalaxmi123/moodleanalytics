 ...
 */
 M.corplms_competencyitem = M.corplms_competencyitem || {
    ...
    init: function(Y, args){
        ...
        ///
        (function() {
            var url = M.cfg.wwwroot+'/corplms/hierarchy/prefix/competency/related/';
            corplmsMultiSelectDialog(
                'related',
                M.util.get_string('assignrelatedcompetencies', 'corplms_hierarchy'),
                url+'find.php?id='+M.corplms_competencyitem.config.id,
                url+'save.php?id='+M.corplms_competencyitem.config.id+'&deleteexisting=1&add='
            );
        })();

        if (typeof M.corplms_competencyitem.config.competencyuseresourcelevelevidence !== 'undefined' &&
            M.corplms_competencyitem.config.competencyuseresourcelevelevidence) {
            ...
            corplmsDialog_handler_assignEvidence.prototype._handle_course_click = function(id) {
                // Load course details
                var url = this.baseurl+'course.php?id='+id+'&competency='+M.corplms_competencyitem.config.id;
            ...
            corplmsDialog_handler_assignEvidence.prototype._display_evidence = function(response) {
                ...
                $('#available-evidence', this._dialog.dialog).find('.addbutton').click(function(e) {
                    ...
                    var url = handler.baseurl+'add.php?competency='+M.corplms_competencyitem.config.id+'&type='+type+'&instance='+instance;
            ...
            (function() {
                var url = M.cfg.wwwroot+'/corplms/hierarchy/prefix/competency/evidenceitem/';
                var saveurl = url + 'add.php?competency='+M.corplms_competencyitem.config.id+'&type=coursecompletion&instance=0&deleteexisting=1&update=';
                var buttonsObj = {};
                ...
                corplmsDialogs['evidence'] = new corplmsDialog(
                    ...
                    url+'edit.php?id='+M.corplms_competencyitem.config.id,
                    handler
                );
            })();
        }
