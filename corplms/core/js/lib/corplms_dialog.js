 ...
 */
M.corplms_dialog = M.corplms_dialog || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_dialog.init()-> jQuery dependency required for this module to function.');
        }
    }
};
...
// Dialog object
function corplmsDialog(title, buttonid, config, default_url, handler) {
    ...
    this.setup = function() {
        ...
        $('<div class="corplms-dialog" style="display: none;"><div id="'+this.title+'"></div></div>').appendTo($('body'));
...
/*****************************************************************************/
/** corplmsDialog_handler **/

function corplmsDialog_handler() {

    // Reference to the corplmsDialog object
    var _dialog;
 ...
 * @return void
 */
corplmsDialog_handler.prototype._setup = function(dialog) {
    this._dialog = dialog;
 ...
 * @return void
 */
corplmsDialog_handler.prototype._load = function(dialog) {
 ...
 * @return void
 */
corplmsDialog_handler.prototype._update = function(response) {
    ...
    $('.corplms-noscript', $('div.list-'+this._title)).hide();
 ...
 * @return array
 */
corplmsDialog_handler.prototype._get_ids = function(elements, prefix) {
 ...
 * @return void
 */
corplmsDialog_handler.prototype._save = function(url) {
 ...
 * @return void
 */
corplmsDialog_handler.prototype._cancel = function() {
    this._dialog.hide();
    return;
}
 ...
 * @return void
 */
corplmsDialog_handler.prototype._set_framework = function() {
 ...
 * @return void
 */
corplmsDialog_handler.prototype._set_plan = function() {
...
/*****************************************************************************/
/** corplmsDialog_handler_treeview **/

corplmsDialog_handler_treeview = function() {};

corplmsDialog_handler_treeview.prototype = new corplmsDialog_handler();
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype.setup_tabs = function(e, ui) {
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype.first_load = function() {
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._partial_load = function(parent_element) {
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._update_hierarchy = function(response, parent_id) {
    var items = response;
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._toggle_items = function(elid, type) {
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._make_deletable = function(parent_element) {
 ...
 * @return void
 */
corplmsDialog_handler_treeview.prototype._append_to_selected = function(element) {
...
/*****************************************************************************/
/** corplmsDialog_handler_treeview_multiselect **/

corplmsDialog_handler_treeview_multiselect = function() {};
corplmsDialog_handler_treeview_multiselect.prototype = new corplmsDialog_handler_treeview();
 ...
 * @return void
 */
corplmsDialog_handler_treeview_multiselect.prototype.every_load = function() {
 ...
 * @return void
 */
corplmsDialog_handler_treeview_multiselect.prototype._make_selectable = function(parent_element) {
 ...
 * @return void
 */
corplmsDialog_handler_treeview_multiselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}


/*****************************************************************************/
/** corplmsDialog_handler_treeview_multiselect_rb_filter **/

corplmsDialog_handler_treeview_multiselect_rb_filter = function() {};
corplmsDialog_handler_treeview_multiselect_rb_filter.prototype = new corplmsDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
corplmsDialog_handler_treeview_multiselect_rb_filter.prototype.first_load = function() {
    var id = this._title;
    ...
    $('.multiselect-selected-item', linkcontainer).each(function(i, el) {
        ...
        preselected += '<div class="treeview-selected-item"><span id="item_'+item_id+'"><a href="#">'+item_name+'</a><span class="deletebutton">'
                    + M.util.get_string('delete', 'corplms_core')
                    +'</span></span></div>';
...
corplmsDialog_handler_treeview_multiselect_rb_filter.prototype._update = function(response) {
    var id = this._title;
...
/*****************************************************************************/
/** corplmsDialog_handler_treeview_singleselect **/

corplmsDialog_handler_treeview_singleselect = function(value_element_name, text_element_id, dualpane) {
...
corplmsDialog_handler_treeview_singleselect.prototype = new corplmsDialog_handler_treeview();
 ...
 * @return void
 */
corplmsDialog_handler_treeview_singleselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}
 ...
 * @return  void
 */
corplmsDialog_handler_treeview_singleselect.prototype.setup_delete = function() {
    this.deletable = true;

    var textel = $('#'+this.text_element_id);
    var idel = $('input[name='+this.value_element_name+']');
    var deletebutton = $('<a href="#" class="dialog-singleselect-deletable">'+M.util.get_string('delete', 'corplms_core')+'</a>');
    var handler = this;
 ...
 * @return void
 */
corplmsDialog_handler_treeview_singleselect.prototype.first_load = function() {

    // Setup dialog
    corplmsDialog_handler_treeview.prototype.first_load.call(this);
 ...
 * @return void
 */
corplmsDialog_handler_treeview_singleselect.prototype.every_load = function() {

    this._make_selectable($('.treeview', this._container));
}

corplmsDialog_handler_treeview_singleselect.prototype._set_current_selected = function() {
 ...
 * @return void
 */
corplmsDialog_handler_treeview_singleselect.prototype._save = function() {
    dialog = this;
    ...
    if (selected_val === "0") {
        alert(M.util.get_string('error:'+this._title+'notselected', 'corplms_core'));
        return false;
    }
 ...
 * @return void
 */
corplmsDialog_handler_treeview_singleselect.prototype._make_selectable = function(parent_element) {
...
/*****************************************************************************/
/** corplmsDialog_handler_skeletalTreeview **/

corplmsDialog_handler_skeletalTreeview = function() {};
corplmsDialog_handler_skeletalTreeview.prototype = new corplmsDialog_handler_treeview();
 ...
 * @return void
 */
corplmsDialog_handler_skeletalTreeview.prototype.every_load = function() {
 ...
 * @return void
 */
corplmsDialog_handler_skeletalTreeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
corplmsDialog_handler_skeletalTreeview.prototype._update_hierarchy = function(response, parent_id) {
...
* @return void
*/
corplmsDialog_handler_skeletalTreeview.prototype._make_selectable = function(elements, addclickable) {
    var handler = this;
...
/*****************************************************************************/
/** corplmsDialog_handler_form **/

corplmsDialog_handler_form = function() {};
corplmsDialog_handler_form.prototype = new corplmsDialog_handler();


/**
 * Add custom submit handler to forms in dialog
 */
corplmsDialog_handler_form.prototype.every_load = function() {
    var handler = this;
 ...
 */
corplmsDialog_handler_form.prototype.submit = function() {
 ...
 * @return  void
 */
corplmsDialog_handler_form.prototype._updatePage = function(response) {
...
/*****************************************************************************/
/** corplmsDialog_handler_selectable **/

corplmsDialog_handler_selectable = function(selected) { this.selected = selected; };
corplmsDialog_handler_selectable.prototype = new corplmsDialog_handler();

corplmsDialog_handler_selectable.prototype.first_load = function() {
    // Setup selectable
...
corplmsDialog_handler_selectable.prototype.every_load = function() {
    corplmsDialog_handler_selectable.prototype.first_load.call(this);
};

corplmsDialog_handler_selectable.prototype._updatePage = function(response) {
...
corplmsDialog_handler_selectable.prototype._set_selected = function() {
 ...
 * @return void
 */
corplmsSingleSelectDialog = function(name, title, find_url, value_element, text_element, handler_extra, deletable) {

    var handler = new corplmsDialog_handler_treeview_singleselect(value_element, text_element);
    var buttonObj = {};
    if (deletable) {
        handler.setup_delete();
    }
 ...
 * @return void
 */
corplmsMultiSelectDialog = function(name, title, find_url, save_url) {

    var handler = new corplmsDialog_handler_treeview_multiselect();

    var buttonObj = {};
    buttonObj[M.util.get_string('save', 'corplms_core')] = function() { handler._save(save_url) };
    buttonObj[M.util.get_string('cancel', 'moodle')] = function() { handler._cancel() };
 ...
 * @return void
 */
corplmsMultiSelectDialogRbFilter = function(name, title, find_url, save_url) {

    var handler = new corplmsDialog_handler_treeview_multiselect_rb_filter();
