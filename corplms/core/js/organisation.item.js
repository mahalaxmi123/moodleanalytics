 ...
 */
M.corplms_organisationitem = M.corplms_organisationitem || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_competencyitem.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.corplms_organisationitem.config.id;
                var sesskey = M.corplms_organisationitem.config.sesskey;
        ...
        //
        (function() {
            var url = M.cfg.wwwroot+ '/corplms/hierarchy/prefix/organisation/assigncompetency/';
            var id = M.corplms_organisationitem.config.id;
            var fid = M.corplms_organisationitem.config.frameworkid;
