 ...
 */
M.corplms_positionitem = M.corplms_positionitem || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_positionitem.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.corplms_positionitem.config.id;
                var sesskey = M.corplms_positionitem.config.sesskey;
        ...
        ///
        (function() {
            var url = M.cfg.wwwroot+ '/corplms/hierarchy/prefix/position/assigncompetency/';
            var id = M.corplms_positionitem.config.id;
            var fid = M.corplms_positionitem.config.frameworkid;
            corplmsMultiSelectDialog(
                'assignedcompetencies',
                M.util.get_string('assigncompetencies', 'corplms_hierarchy'),
        ...
        (function() {
            var url = M.cfg.wwwroot+ '/corplms/hierarchy/prefix/position/assigncompetencytemplate/';
            var id = M.corplms_positionitem.config.id;
            var fid = M.corplms_positionitem.config.frameworkid;
            corplmsMultiSelectDialog(
                'assignedcompetencytemplates',
                M.util.get_string('assigncompetencytemplate', 'corplms_hierarchy'),
                url+'find.php?assignto='+id+'&frameworkid='+fid+'&add=',
                url+'assign.php?assignto='+id+'&frameworkid='+fid+'&deleteexisting=1&add='
            );
        })();
        ...
        $(corplmsDialogs.assignedcompetencies.dialog).bind('ajaxComplete', function(event) {
