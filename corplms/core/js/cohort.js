 ...
 */
M.corplms_cohort = M.corplms_cohort || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_cohort.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.corplms_cohort.config.id;
                var sesskey = M.corplms_cohort.config.sesskey;
        ...
        (function() {
            ...
            corplmsSingleSelectDialog(
                'position',
                M.util.get_string('chooseposition', 'corplms_hierarchy') +
        ...
        (function() {
            ...
            corplmsSingleSelectDialog(
                'organisation',
                M.util.get_string('chooseorganisation', 'corplms_hierarchy') +
        ...
        (function() {
            ...
            var dialog = new corplmsDialog(
                name,
                'id_submitbutton',
                {
                    buttons: buttonsObj,
                    title: '<h2>'+ M.util.get_string('confirmdynamiccohortcreation', 'corplms_cohort') +'</h2>'
                },
                '',
                handler
            );
