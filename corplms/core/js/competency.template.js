 ...
 */
M.corplms_competencytemplate = M.corplms_competencytemplate || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_competencytemplate.init()-> jQuery dependency required for this module to function.');
        }

        ///
        /// Add related competency dialog
        ///
        var url = M.cfg.wwwroot+'/corplms/hierarchy/prefix/competency/template/';
