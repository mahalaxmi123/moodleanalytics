 ...
 */
define('CORPLMS_DIALOG_MAXITEMS', 1000);
...
class corplms_dialog_content {
     ...
     * @var     string
     */
    public $search_code = '/corplms/core/dialogs/search.php';
    ...
    public function generate_markup() {
        ...
        $markup .= '  <li><a href="#browse-tab">'.get_string('browse', 'corplms_core').'</a></li>';
                ...
                foreach ($this->items as $element) {
                    ...
                    if (isset($element->fullname)) {
                        if (isset($element->email) && $canviewemail) {
                            $displayname = get_string('assignindividual', 'corplms_program', $element);
                        } else {
    ...
    public function generate_search() {
        ...
        define('CORPLMS_DIALOG_SEARCH', true);
        ob_start();
