 ...
 * @access  public
 */
class corplms_dialog_content_certifications extends corplms_dialog_content {
     ...
     *
     * @see     corplms_dialog_hierarchy::categoryid
     *
     * @access  public
    ...
    public function load_categories() {
        ...
        if (!$this->categoryid) {
            ...
            if (!$parent = $DB->get_record('course_categories', array('id' => $this->categoryid))) {
                print_error('error:categoryidincorrect', 'corplms_core');
            }
        }
        ...
        $category_item_counts = (count($category_ids) > 0) ? corplms_get_category_item_count($category_ids, 'certification') : array();
