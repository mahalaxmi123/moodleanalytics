 ...
 * @access  public
 */
class corplms_dialog_content_courses extends corplms_dialog_content {
    ...
    public function load_categories() {
        ...
        $category_item_counts = (count($category_ids) > 0) ? corplms_get_category_item_count($category_ids, 'course') : array();
