...
class corplms_dialog_content_required_learning extends corplms_dialog_content {
    ...
    public function get_search_info(stdClass $search_info, array $keywords) {
        ...
        if ($keywords) {
            list($searchsql, $searchparams) = corplms_search_get_keyword_where_clause($keywords, array('prog.fullname'));
