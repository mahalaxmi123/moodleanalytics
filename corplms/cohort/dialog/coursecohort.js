...
M.corplms_coursecohort = M.corplms_coursecohort || {
    ...
    init_dialogs: function() {
        ...
        // Enrolled cohorts
        var ehandler = new corplmsDialog_handler_coursecohorts();
        ...
        corplmsDialogs['id_cohortsaddenrolled'] = new corplmsDialog(
            'course-cohorts-enrolled-dialog',
            'id_cohortsaddenrolled',
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string('coursecohortsenrolled', 'corplms_cohort') + '</h2>'
            },
...
corplmsDialog_handler_coursecohorts = function() {
    // Base url
    this.baseurl = '';
...
corplmsDialog_handler_coursecohorts.prototype = new corplmsDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
corplmsDialog_handler_coursecohorts.prototype._update = function(response) {
 ...
 **/
corplmsDialog_handler_coursecohorts.prototype.cohort_item_exists = function(itemid) {
...
corplmsDialog_handler_coursecohorts.prototype.check_table_hidden_status = function() {
...
corplmsDialog_handler_coursecohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 ** Adds an item
 **/
corplmsDialog_handler_coursecohorts.prototype.add_cohort_item = function(itemid) {
 ...
 **/
corplmsDialog_handler_coursecohorts.prototype.create_item = function(html) {
    var element = $(html);
...
corplmsDialog_handler_coursecohorts.prototype.remove_cohort_item = function(item) {
