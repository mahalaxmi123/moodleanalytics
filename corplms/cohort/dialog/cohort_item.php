...
if (false == (has_capability('moodle/cohort:view', $context) || has_capability('moodle/cohort:manage', $contextsystem))) {
    print_error('error:capabilitycohortview', 'corplms_cohort');
}

$PAGE->set_context($context);
$PAGE->set_url('/corplms/cohort/dialog/cohort_item.php');

$ccohort = new corplms_cohort_course_cohorts();
...
$html = get_string('youhaveadded', 'corplms_cohort', $a);
