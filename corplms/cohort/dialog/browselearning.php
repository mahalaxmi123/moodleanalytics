...
require_once($CFG->dirroot.'/corplms/core/dialogs/dialog_content_certifications.class.php');
...
$assigned = corplms_cohort_get_associations($cohortid, $type, $value);
$selected = array();
...
switch ($type) {
    case COHORT_ASSN_ITEMTYPE_COURSE:
        $dialog = new corplms_dialog_content_courses($categoryid);
        break;
    case COHORT_ASSN_ITEMTYPE_PROGRAM:
        $dialog = new corplms_dialog_content_programs($categoryid);
        break;
    case COHORT_ASSN_ITEMTYPE_CERTIF:
        $dialog = new corplms_dialog_content_certifications($categoryid);
        break;
    default:
