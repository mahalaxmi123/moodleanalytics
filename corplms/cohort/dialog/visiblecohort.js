...
M.corplms_visiblecohort = M.corplms_visiblecohort || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_visiblecohort.init()-> jQuery dependency required for this module.');
        }
    ...
    init_dialogs: function() {
        ...
        var ehandler = new corplmsDialog_handler_visiblecohorts();
        ...
        corplmsDialogs['id_cohortsaddvisible'] = new corplmsDialog(
            'course-cohorts-visible-dialog',
            'id_cohortsaddvisible',
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string(this.config.type + 'cohortsvisible', 'corplms_cohort') + '</h2>'
            },
...
corplmsDialog_handler_visiblecohorts = function() {
    this.baseurl = '';
...
corplmsDialog_handler_visiblecohorts.prototype = new corplmsDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
corplmsDialog_handler_visiblecohorts.prototype._update = function(response) {
    ...
    if (newids.length > 0) {
        ...
        var ajax_url = M.cfg.wwwroot + '/corplms/cohort/dialog/cohort_item.php?itemid=' + newids.join(',') + params;
 ...
 **/
corplmsDialog_handler_visiblecohorts.prototype.cohort_item_exists = function(itemid) {
...
corplmsDialog_handler_visiblecohorts.prototype.check_table_hidden_status = function() {
...
corplmsDialog_handler_visiblecohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 ** Adds an item
 **/
corplmsDialog_handler_visiblecohorts.prototype.add_cohort_item = function(itemid) {
 ...
 **/
corplmsDialog_handler_visiblecohorts.prototype.create_item = function(html) {
    var element = $(html);
...
corplmsDialog_handler_visiblecohorts.prototype.remove_cohort_item = function(item) {
