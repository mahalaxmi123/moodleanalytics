...
/**
 * This file defines the two corplms_dialog_content subclasses used in browselearning.php;
 ...
 * @access  public
 */
class corplms_dialog_content_cohort_courses extends corplms_dialog_content_courses {
    ...
    protected function _prepend_markup() {
        return display_dialog_selector(
            array(
                COHORT_ASSN_ITEMTYPE_COURSE => get_string('learningitemcourses', 'corplms_cohort'),
                COHORT_ASSN_ITEMTYPE_PROGRAM => get_string('learningitemprograms', 'corplms_cohort')
            ),
 ...
 * @access  public
 */
class corplms_dialog_content_cohort_programs extends corplms_dialog_content_programs {
