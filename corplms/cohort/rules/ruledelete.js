...
M.corplms_cohortruledelete = M.corplms_cohortruledelete || {
    ...
    init_deletelisteners: function() {
        ...
        $('#cohort-rules').on('click', 'a.ruledef-delete', function(e, postdeletecallback) {
            ...
            confirmed = confirm(M.util.get_string('deleteruleconfirm', 'corplms_cohort'));
            ...
            $.ajax({
                url: M.cfg.wwwroot + '/corplms/cohort/rules/ruledelete.php',
                type: "GET",
                data: ({
                ...
                beforeSend: function() {
                    var loadingimg = '<img src="' + M.util.image_url('i/ajaxloader', 'moodle') + '" alt="' + M.util.get_string('savingrule', 'corplms_cohort') + '" class="iconsmall" />';
                ...
                success: function(o) {
                    if (o.length > 0) {
                        ...
                        alert(M.util.get_string('error:noresponsefromajax', 'corplms_cohort'));
                        location.reload();
                    }
                }, // success
        ...
        $('#cohort-rules').on('click', 'a img.ruleparam-delete', function(e, postdeletecallback) {
            ...
            confirmed = confirm(M.util.get_string('deleteruleparamconfirm', 'corplms_cohort'));
            ...
            $.ajax({
                url: M.cfg.wwwroot + '/corplms/cohort/rules/ruleparamdelete.php',
                type: "GET",
                data: ({
                    sesskey: M.cfg.sesskey,
