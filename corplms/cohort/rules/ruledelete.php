...
add_to_log(SITEID, 'cohort', 'delete rule', 'corplms/cohort/rules.php?id='.$colldetails->cohortid, "ruleid={$ruleid}&rulesetid={$rule->rulesetid}&ruletype={$rule->ruletype}&rulename={$rule->name}");
