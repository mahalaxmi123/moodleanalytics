 ...
 * vendor/bin/phpunit corplms_cohort_program_completion_rules_testcase
 *
 */
class corplms_cohort_program_completion_rules_testcase extends reportcache_advanced_testcase {
