...
$capabilities = array(
    ...
    // View a program
    'corplms/program:viewprogram' => array(
        'captype' => 'read',
    ...
    'corplms/program:viewhiddenprograms' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_PROGRAM,
        'archetypes' => array(
    ...
    'corplms/program:accessanyprogram' => array(
    ...
    // Create new programs
    'corplms/program:createprogram' => array(
    ...
    // Delete programs
    'corplms/program:deleteprogram' => array(
        ...
        'clonepermissionsfrom' => 'corplms/program:createprogram'
    ),
    ...
    'corplms/program:configuredetails' => array(
    ...
    'corplms/program:configurecontent' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'corplms/program:configureassignments' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'corplms/program:configuremessages' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'corplms/program:handleexceptions' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'corplms/program:visibility' => array(
    ...
    'corplms/program:markstaffcoursecomplete' => array(
