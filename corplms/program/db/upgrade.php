 ...
 */
function xmldb_corplms_program_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2012070600) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012070600, 'corplms_program');
    }
    ...
    if ($oldversion < 2012072700) {
        ...
        $DB->execute($sql);
        corplms_upgrade_mod_savepoint(true, 2012072700, 'corplms_program');
    }

    if ($oldversion < 2012072701) {
        // Fix context levels on program capabilities
        $like_sql = $DB->sql_like('name', '?');
        $params = array(CONTEXT_PROGRAM, 'corplms/program%');
        $DB->execute("UPDATE {capabilities} SET contextlevel = ? WHERE $like_sql", $params);
        corplms_upgrade_mod_savepoint(true, 2012072701, 'corplms_program');
    }
    ...
    if ($oldversion < 2012080300) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012080300, 'corplms_program');
    }
    ...
    if ($oldversion < 2012080301) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012080301, 'corplms_program');
    }
    ...
    if ($oldversion < 2012081500) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012081500, 'corplms_program');
    }
    ...
    if ($oldversion < 2012081503) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012081503, 'corplms_program');
    }
    ...
    if ($oldversion < 2013090900) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013090900, 'corplms_program');
    }
    ...
    if ($oldversion < 2013091000) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013091000, 'corplms_program');
    }
    ...
    if ($oldversion < 2013092100) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013092100, 'corplms_program');
    }
    ...
    if ($oldversion < 2013101500) {
        ...
        // Main savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2013101500, 'corplms_program');
    }
    ...
    if ($oldversion < 2014022000) {
        ...
        corplms_upgrade_mod_savepoint(true, 2014022000, 'corplms_program');
    }
    ...
    if ($oldversion < 2014030500) {
        ...
        // Main savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2014030500, 'corplms_program');
    }
    ...
    if ($oldversion < 2014030600) {
        ...
        // Main savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2014030600, 'corplms_program');
    }
    ...
    if ($oldversion < 2014061600) {
        ...
        // Main savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2014061600, 'corplms_program');
    }
