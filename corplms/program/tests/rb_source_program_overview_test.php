...
//require_once ($CFG->dirroot.'/corplms/program/rb_sources/rb_source_program_overview.php');
class corplms_program_rb_source_program_overview_testcase extends reportcache_advanced_testcase {
    protected $load = 0;
