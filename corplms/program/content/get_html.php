...
if ($htmltype == 'multicourseset') { // if a new mulitcourse set is being added
    ...
    $newcourseset->label = get_string('legend:courseset', 'corplms_program', $sortorder);
    ...
    $newcourseset->islastset = true;
    $newcourseset->label = get_string('legend:recurringcourseset', 'corplms_program');
    ...
    if ($nojs) {
        ...
        $returnurl = new moodle_url('/corplms/program/edit_content.php', array('id' => $id));
        redirect($returnurl);
    } else {
