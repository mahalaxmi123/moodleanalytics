...
require_capability('corplms/program:configureassignments', program_get_context($programid));
...
$dialog = new corplms_dialog_content_hierarchy_multi($type, $frameworkid, false, $skipaccesschecks=true);
