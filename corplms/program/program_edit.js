 ...
 * @subpackage program
 */
M.corplms_programedit = M.corplms_programedit || {
    ...
    init: function(Y, args){
        ...
        if (!this.config.id) {
            throw new Error('M.corplms_programedit.init()-> Required config \'id\' not available.');
        }

        // check jQuery dependency and continue with setup
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_programedit.init()-> jQuery dependency required for this module to function.');
        }
