...
class program_courseset_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcoursesetcompletion', 'corplms_program');
    }
    ...
    public function get_url() {
        return new \moodle_url('/corplms/program/required.php', array('id' => $this->objectid, 'userid' => $this->userid));
    }
