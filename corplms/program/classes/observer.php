...
class corplms_program_observer {
     ...
     *
     * @param \corplms_program\event\program_courseset_completed $event
     * @return bool Success status
     */
    public static function courseset_completed(\corplms_program\event\program_courseset_completed $event) {
        global $DB;
     ...
     *
     * @param \corplms_core\event\user_firstlogin $event
     * @return boolean True if all the update_learner_assignments() succeeded or there was nothing to do
     */
    public static function assignments_firstlogin(\corplms_core\event\user_firstlogin $event) {
        global $CFG, $DB;
