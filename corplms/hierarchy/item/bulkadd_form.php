...
class item_bulkadd_form extends moodleform {
    ...
    function definition() {
        ...
        $parents[0] = get_string('top', 'corplms_hierarchy');
        ...
        $mform->addElement('static', 'framework', get_string($prefix.'framework', 'corplms_hierarchy'), $framework->fullname);
        ...
        if ($types) {
            ...
            $mform->addElement('select', 'typeid', get_string('type', 'corplms_hierarchy'), $select);
        ...
        $mform->addElement('textarea', 'itemnames', get_string('enternamesoneperline', 'corplms_hierarchy', get_string($prefix, 'corplms_hierarchy')), 'rows="15" cols="50"');
