...
$skipaccess = (get_config('corplms_hierarchy', 'allowsignupposition') && $USER->id == 0);
if (!$skipaccess) {
    require_login();
}
///
...
$dialog = new corplms_dialog_content_hierarchy('position', $frameworkid, false, $skipaccess);
