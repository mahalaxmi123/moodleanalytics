...
$skipaccess = (get_config('corplms_hierarchy', 'allowsignuporganisation') && $USER->id == 0);
if (!$skipaccess) {
    require_login();
}
...
$dialog = new corplms_dialog_content_hierarchy('organisation', $frameworkid, false, $skipaccess);
