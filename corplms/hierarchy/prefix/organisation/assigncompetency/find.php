...
if (!$nojs) {
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        echo build_nojs_frameworkpicker(
            $hierarchy,
            '/corplms/hierarchy/prefix/organisation/assigncompetency/find.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .= build_nojs_treeview(
            ...
            '/corplms/hierarchy/prefix/organisation/assigncompetency/assign.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
            ...
            $CFG->wwwroot.'/corplms/hierarchy/prefix/organisation/assigncompetency/find.php',
            $urlparams,
