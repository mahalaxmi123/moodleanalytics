...
class edit_scale_form extends moodleform {
    public function definition() {
        ...
        $mform->addHelpButton('name', 'goalscalescalename', 'corplms_hierarchy');
        ...
        if ($this->_customdata['scaleid'] == 0) {
            $mform->addElement('textarea', 'scalevalues', get_string('scalevalues', 'corplms_hierarchy')
                ...
                . '(' . get_string('goalnotescalevalueentry', 'corplms_hierarchy'). ')'
                . html_writer::end_tag('i'), 'rows="5" cols="30"');
            $mform->addHelpButton('scalevalues', 'goalscalescalevalues', 'corplms_hierarchy');
            ...
            $link = html_writer::link($linkurl, get_string('linktoscalevaluesgoal', 'corplms_hierarchy'));
