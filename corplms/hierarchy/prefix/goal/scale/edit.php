...
if ($mform->is_cancelled()) {
    // If cancelled.
    redirect("$CFG->wwwroot/corplms/hierarchy/framework/index.php?prefix=goal");
    ...
    if (empty($scalenew->id)) {
        ...
        $notification->url = "$CFG->wwwroot/corplms/hierarchy/prefix/goal/scale/view.php?id={$scalenew->id}&amp;prefix=goal";
    ...
    $scalenew = file_postupdate_standard_editor($scalenew, 'description', $TEXTAREA_OPTIONS, $TEXTAREA_OPTIONS['context'],
        'corplms_hierarchy', 'goal_scale', $scalenew->id);
