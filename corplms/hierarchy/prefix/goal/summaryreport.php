...
$url = new moodle_url('/corplms/hierarchy/prefix/goal/summaryreport.php', array('format' => $format, 'debug' => $debug));
admin_externalpage_setup('goalreport', '', null, $url);

$context = context_system::instance();
$canedit = has_capability('corplms/hierarchy:editgoalreport', $context);
...
if (!$goalframeworkid) {
    echo $OUTPUT->header();
    $overviewurl = new moodle_url('/corplms/hierarchy/prefix/goal/reports.php');
...
$heading = get_string('goalsummaryreportforx', 'corplms_hierarchy', $goalframework->fullname);
