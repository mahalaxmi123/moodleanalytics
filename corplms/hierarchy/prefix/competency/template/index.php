...
$can_add = has_capability('corplms/hierarchy:create'.$hierarchy->prefix.'template', $sitecontext);
$can_edit = has_capability('corplms/hierarchy:update'.$hierarchy->prefix.'template', $sitecontext);
$can_delete = has_capability('corplms/hierarchy:delete'.$hierarchy->prefix.'template', $sitecontext);
