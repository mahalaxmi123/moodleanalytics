...
// Setup page
admin_externalpage_setup('competencymanage', '', array(), '/corplms/hierarchy/prefix/competency/evidence/add.php');
...
if (!$nojs) {
    ...
    $dialog = new corplms_dialog_content_hierarchy('competency', $frameworkid, $showhidden);
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        $out .= build_nojs_frameworkpicker(
            $hierarchy,
            '/corplms/hierarchy/prefix/competency/assign/find.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .=  build_nojs_treeview(
            ...
            '/corplms/hierarchy/prefix/competency/assign/save.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
