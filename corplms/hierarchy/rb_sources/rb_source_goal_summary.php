...
class rb_source_goal_summary extends rb_base_source {
    ...
    public function post_params(reportbuilder $report) {
        ...
        $this->set_redirect(new moodle_url('/corplms/hierarchy/rb_sources/goalsummaryselector.php',
                array('summaryreportid' => $report->_id)),
                get_string('selectgoalframework', 'corplms_hierarchy'));
    ...
    public function rb_display_namesummarylink($name, $row, $isexport = false) {
        ...
        $url = new moodle_url('/corplms/hierarchy/prefix/goal/statusreport.php',
