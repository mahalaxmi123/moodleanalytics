...
class certification_add_form extends moodleform {
    ...
    public function definition() {
        ...
        $comptypeoptions = array(
            CERTIFTYPE_PROGRAM => get_string('program', 'corplms_certification'),
        );
        $mform->addElement('select', 'comptype', get_string('comptype', 'corplms_certification'), $comptypeoptions);

        $mform->addHelpButton('comptype', 'comptype', 'corplms_certification');
