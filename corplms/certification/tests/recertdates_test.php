 ...
 * vendor/bin/phpunit --verbose corplms_certification_recertdates_testcase corplms/certification/tests/recertdates_test.php
 *
 * @package    corplms_certifications
 * @category   phpunit
 * @group      corplms_certifications
 * @author     Jon Sharp <jonathans@catalyst-eu.net>
 * @copyright  Catalyst IT Ltd 2013 <http://catalyst-eu.net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class corplms_certification_recertdates_testcase extends advanced_testcase {
