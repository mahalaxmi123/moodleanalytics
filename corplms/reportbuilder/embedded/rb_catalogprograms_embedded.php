...
class rb_catalogprograms_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        $this->url = $this->url = '/corplms/coursecatalog/programs.php';
        $this->source = 'program';
        $this->shortname = 'catalogprograms';
        $this->fullname = get_string('catalogprograms', 'corplms_coursecatalog');
        ...
        $this->columns = array(
            ...
            array(
                'type' => 'prog',
                'value' => 'summary',
                'heading' => get_string('programsummary', 'corplms_program'),
            )
        );
    ...
    public function get_extrabuttons() {
        ...
        if (has_capability('corplms/program:createprogram', $catcontext)) {
            $createurl = new moodle_url("/corplms/program/add.php", array('category' => $defaultcat));
            $createbutton = new single_button($createurl, get_string('addprogram', 'corplms_coursecatalog'), 'get');
