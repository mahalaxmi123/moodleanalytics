...
class rb_plan_courses_completion_history_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $url = new moodle_url('/corplms/plan/record/courses.php', array('history' => 1));
        ...
        $this->fullname = get_string('recordoflearningcoursescompletionhistory', 'corplms_plan');
        $this->columns = array(
            array(
                'type' => 'course',
                'value' => 'coursetypeicon',
                'heading' => get_string('coursetypeicon', 'corplms_reportbuilder'),
            ),
            array(
                'type' => 'course',
                'value' => 'courselink',
