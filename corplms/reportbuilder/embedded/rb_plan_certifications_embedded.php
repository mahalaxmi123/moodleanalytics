...
class rb_plan_certifications_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/corplms/plan/record/certifications.php';
        ...
        $this->fullname = get_string('recordoflearningcertifications', 'corplms_plan');
        $this->columns = array(
            array(
                'type' => 'base',
                'value' => 'fullnamelink',
                'heading' => get_string('certificationname', 'corplms_program'),
            ),
            array(
                'type' => 'certif_completion',
                'value' => 'timedue',
                'heading' => get_string('certificationduedate', 'corplms_program'),
            ),
            array(
                'type' => 'certif_completion',
                'value' => 'certifpath',
        ...
        if (!has_capability('corplms/certification:viewhiddencertifications', $context)) {
