...
class rb_plan_programs_completion_history_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $url = new moodle_url('/corplms/plan/record/programs.php', array('history' => 1));
        ...
        $this->fullname = get_string('recordoflearningprogramscompletionhistory', 'corplms_plan');
        $this->columns = array(
            array(
                'type' => 'program',
                'value' => 'proglinkicon',
                'heading' => get_string('prognamelinkedicon', 'corplms_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'timedue',
                'heading' => get_string('programduedate', 'corplms_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'timecompleted',
