...
class rb_cohort_admin_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->fullname = get_string('cohortadminreportname', 'corplms_cohort');
        $this->columns = array(
            array(
                'type' => 'cohort',
                'value' => 'namelink',
                'heading' => get_string('name', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'idnumber',
                'heading' => get_string('idnumber', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'numofmembers',
                'heading' => get_string('numofmembers', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'type',
                'heading' => get_string('type', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'startdate',
                'heading' => get_string('startdate', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'enddate',
                'heading' => get_string('enddate', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'status',
                'heading' => get_string('status', 'corplms_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'actions',
                'heading' => get_string('actions', 'corplms_cohort')
            )
        );
