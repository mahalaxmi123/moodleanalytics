...
class rb_plan_programs_recurring_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/corplms/plan/record/programs_recurring.php';
        $this->source = 'dp_program_recurring';
        $this->shortname = 'plan_programs_recurring';
        $this->fullname = get_string('recordoflearningprogramsrecurring', 'corplms_plan');
        $this->columns = array(
            array(
                'type' => 'program_completion_history',
                'value' => 'courselink',
                'heading' => get_string('coursenamelink', 'corplms_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'status',
                'heading' => get_string('completionstatus', 'corplms_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'timecompleted',
                'heading' => get_string('completiondate', 'corplms_program'),
            ),
        );
