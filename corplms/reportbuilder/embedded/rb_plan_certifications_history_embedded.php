...
class rb_plan_certifications_history_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $url = new moodle_url('/corplms/plan/record/certifications.php', array('history' => true));
        ...
        $this->fullname = get_string('recordoflearningcertificationshistory', 'corplms_plan');
        $this->columns = array(
            array(
                'type' => 'prog',
                'value' => 'fullnamelink',
