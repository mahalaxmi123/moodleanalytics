...
class rb_alerts_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/corplms/message/alerts.php';
        $this->source = 'corplmsmessages';
        $this->shortname = 'alerts';
        $this->fullname = get_string('alerts', 'corplms_message');
        $this->columns = array(
            array(
                'type' => 'message_values',
                'value' => 'msgtype',
                'heading' => get_string('type', 'rb_source_corplmsmessages'),
            ),
            array(
                'type' => 'user',
                'value' => 'namelink',
                'heading' => get_string('name', 'rb_source_corplmsmessages'),
            ),
            array(
                'type' => 'message_values',
                'value' => 'statement',
                'heading' => get_string('details', 'rb_source_corplmsmessages'),
            ),
            array(
                'type' => 'message_values',
                'value' => 'sent',
                'heading' => get_string('sent', 'rb_source_corplmsmessages'),
            ),
        );
    ...
    public function is_capable($reportfor, $report) {
        ...
        return ($reportfor == $subjectid ||
                ...
                has_capability('corplms/message:viewallmessages', context_system::instance(), $reportfor));
    }
}
