...
$PAGE->set_url('/corplms/reportbuilder/report.php', array('id' => $id));
...
if ($report->embedded) {
    print_error('cannotviewembedded', 'corplms_reportbuilder');
}
...
$pagetitle = format_string(get_string('report', 'corplms_reportbuilder').': '.$fullname);
