...
$PAGE->set_url('/corplms/reportbuilder/save.php', array('id' => $id));
...
$pagetitle = format_string(get_string('savesearch', 'corplms_reportbuilder').': '.$fullname);

$PAGE->set_title($pagetitle);
$PAGE->navbar->add(get_string('report', 'corplms_reportbuilder'));
$PAGE->navbar->add($fullname);
$PAGE->navbar->add(get_string('savesearch', 'corplms_reportbuilder'));
