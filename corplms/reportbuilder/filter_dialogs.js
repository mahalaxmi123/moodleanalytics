...
M.corplms_reportbuilder_filterdialogs = M.corplms_reportbuilder_filterdialogs || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.corplms_reportbuilder_filterdialogs.init()-> jQuery dependency required for this module to function.');
        }
                ...
                $('input.rb-filter-choose-org').each(function(i, el) {
                    ...
                    (function() {
                        ...
                        corplmsSingleSelectDialog(
                            id,
                            M.util.get_string('chooseorganisation', 'corplms_hierarchy') + config[id + '-currentlyselected'],
                            url + 'find.php?',
                            id,
                            id + 'title'
                        );
            ...
            case 'pos':
                $('input.rb-filter-choose-pos').each(function(i, el) {
                    ...
                    (function() {
                        ...
                        corplmsSingleSelectDialog(
                            id,
                            M.util.get_string('chooseposition', 'corplms_hierarchy') + config[id + '-currentlyselected'],
                            url + 'position.php?',
                            id,
                            id + 'title'
                        );
            ...
            case 'comp':
                $('input.rb-filter-choose-comp').each(function(i, el) {
                    ...
                    (function() {
                        ...
                        corplmsSingleSelectDialog(
                            id,
                            M.util.get_string('selectcompetency', 'corplms_hierarchy')  + config[id + '-currentlyselected'],
                            url + 'find.php?',
                            id,
                            id + 'title'
                        );
    ...
    rb_load_hierarchy_multi_filters: function() {
        ...
        $('div.rb-org-add-link a').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/corplms/hierarchy/prefix/organisation/assignfilter/';

                corplmsMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('chooseorgplural', 'corplms_reportbuilder'),
                    url + 'find.php?',
        ...
        $('div.rb-pos-add-link a').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/corplms/hierarchy/prefix/position/assignfilter/';

                corplmsMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('chooseposplural', 'corplms_reportbuilder'),
                    url + 'find.php?',
                    url + 'save.php?filtername=' + id + '&ids='
                );
            })();
        ...
        $('div.rb-comp-add-link a').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/corplms/hierarchy/prefix/competency/assignfilter/';

                corplmsMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('choosecompplural', 'corplms_reportbuilder'),
                    url + 'find.php?',
                    url + 'save.php?filtername=' + id + '&ids='
                );
            })();
    ...
    rb_load_cohort_filters: function() {
        ...
        $('div.rb-cohort-add-link a').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/corplms/reportbuilder/ajax/';

                corplmsMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('choosecohorts', 'corplms_cohort'),
                    url + 'find_cohort.php',
    ...
    rb_load_category_filters: function() {
        ...
        $('input.rb-filter-choose-category').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/corplms/reportbuilder/ajax/filter/category/';
                corplmsMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('choosecatplural', 'corplms_reportbuilder'),
