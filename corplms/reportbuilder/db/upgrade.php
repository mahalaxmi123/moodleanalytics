 ...
 */
function xmldb_corplms_reportbuilder_upgrade($oldversion) {
    ...
    if ($oldversion < 2012071300) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012071300, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2012071900) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012071900, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2012073100) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012073100, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2012081000) {
        ...
        $searches->close();
        corplms_upgrade_mod_savepoint(true, 2012081000, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2012112300) {
        ...
        corplms_upgrade_mod_savepoint(true, 2012112300, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013021100) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013021100, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013032700) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013032700, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013061000) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013061000, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013092400) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013092400, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013103000) {
        ...
        corplms_upgrade_mod_savepoint(true, 2013103000, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2013121000) {
        ...
        // Report builder savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2013121000, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2014012400) {
        ...
        $dbman->change_field_precision($table, $field);
        corplms_upgrade_mod_savepoint(true, 2014012400, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2014021100) {
        ...
        // Report builder savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2014021100, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2014030200) {
        ...
        upgrade_plugin_savepoint(true, 2014030200, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014030500) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014030500, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014031400) {
        ...
        // Report builder savepoint reached.
        corplms_upgrade_mod_savepoint(true, 2014031400, 'corplms_reportbuilder');
    }
    ...
    if ($oldversion < 2014082200) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014082200, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014082201) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014082201, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014090900) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014090900, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014092400) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014092400, 'corplms', 'reportbuilder');
    }


    // This is the Corplms 2.7 upgrade line.
    ...
    if ($oldversion < 2014100701) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014100701, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014102300) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014102300, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014110400) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014110400, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014110401) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014110401, 'corplms', 'reportbuilder');
    }
    ...
    if ($oldversion < 2014110402) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2014110402, 'corplms', 'reportbuilder');
    }
