...
class corplms_reportbuilder_events_testcase extends advanced_testcase {
    use corplms_reportbuilder\phpunit\report_testing;
    ...
    public function test_report_created_event() {
        ...
        $event = \corplms_reportbuilder\event\report_created::create_from_report($report, false);
        $event->trigger();
        $data = $event->get_data();
        ...
        $event = reset($events);
        $this->assertInstanceOf('corplms_reportbuilder\event\report_created', $event);
        $data = $event->get_data();
    ...
    public function test_report_updated_event() {
        ...
        $event = \corplms_reportbuilder\event\report_updated::create_from_report($report, 'columns');
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_deleted_event() {
        ...
        $event = \corplms_reportbuilder\event\report_deleted::create_from_report($report, false);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
        ...
        $event = \corplms_reportbuilder\event\report_deleted::create_from_report($report, true);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_viewed_event() {
        ...
        $event = \corplms_reportbuilder\event\report_viewed::create_from_report($report);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
    ...
    public function test_report_exported_event() {
        ...
        $event = \corplms_reportbuilder\event\report_exported::create_from_report($report, REPORT_BUILDER_EXPORT_PDF_LANDSCAPE);
        $event->trigger();
        $data = $event->get_data();
        $this->assertSame($report, $event->get_report());
        $this->assertSame($report->_id, $event->objectid);
