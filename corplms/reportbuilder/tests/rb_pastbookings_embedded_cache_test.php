...
global $CFG;
require_once($CFG->dirroot . '/corplms/reportbuilder/tests/rb_bookings_embedded_cache_test.php');

class corplms_reportbuilder_rb_pastbookings_embedded_cache_testcase extends corplms_reportbuilder_rb_bookings_embedded_cache_testcase {
    // testcase data
