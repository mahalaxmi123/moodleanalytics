...
require_once($CFG->dirroot . '/corplms/reportbuilder/tests/generator/lib.php');

abstract class reportcache_advanced_testcase extends advanced_testcase {
    use corplms_reportbuilder\phpunit\report_testing;

    /** @var corplms_reportbuilder_cache_generator $generator */
     ...
     * @return corplms_reportbuilder_cache_generator
     */
    public static function getDataGenerator() {
        if (is_null(static::$generator)) {
            static::$generator = new corplms_reportbuilder_cache_generator();
        }
