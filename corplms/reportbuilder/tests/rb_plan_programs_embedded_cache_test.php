...
class corplms_reportbuilder_rb_plan_programs_embedded_cache_testcase extends reportcache_advanced_testcase {
    // testcase data
    ...
    protected function setUp() {
        ...
        assign_capability('corplms/plan:accessanyplan', CAP_PROHIBIT, $rolemanager->id, $syscontext);
        ...
        assign_capability('corplms/plan:accessanyplan', CAP_ALLOW, $rolecoursecreator->id, $syscontext);
