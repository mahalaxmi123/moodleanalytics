 ...
 *
 * vendor/bin/phpunit corplms_reportbuilder_column_testcase
 *
 */
...
class corplms_reportbuilder_column_testcase extends reportcache_advanced_testcase {
    ...
    protected $block_corplms_stats_data = array(
    ...
    protected $files_data = array(
        'contextid' => 1, 'itemid' => 1, 'filepath' => '/corplms/', 'filename' => 'icon.gif', 'filesize' => 8,
    ...
    protected $corplms_compl_import_course_data = array(
    ...
    protected $corplms_compl_import_cert_data = array(
    ...
    protected function setUp() {
        ...
        $this->loadDataSet($this->createArrayDataset(array(
            ...
            'block_corplms_stats' => array($this->block_corplms_stats_data),
            ...
            'corplms_sync_log' => array($this->sync_log_data),
            'cohort_visibility' => array($this->visible_cohort_data),
            'appraisal_user_assignment' => array($this->appraisal_user_assignment),
            'corplms_compl_import_course' => array($this->corplms_compl_import_course_data),
            'corplms_compl_import_cert' => array($this->corplms_compl_import_cert_data),
