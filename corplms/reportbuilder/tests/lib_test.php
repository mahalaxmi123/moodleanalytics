 ...
 *
 * Unit tests for corplms/reportbuilder/lib.php
 */
...
class corplms_reportbuilder_lib_testcase extends advanced_testcase {
    /** @var reportbuilder */
    public $rb;
    ...
    function test_reportbuilder_report_url() {
        ...
        $this->assertEquals('/corplms/reportbuilder/report.php?id=1', substr($rb->report_url(), strlen($CFG->wwwroot)));
        $rb2 = new reportbuilder(null, $this->shortname, $this->embed);
        // an embedded report should return the embedded url (this page)
        $this->assertEquals($CFG->wwwroot . '/corplms/plan/record/competencies.php', $rb2->report_url());
    ...
    public function test_get_search_columns_select() {
        ...
        $userstr = get_string('type_user', 'corplms_reportbuilder');
