...
require_once($CFG->dirroot . '/corplms/reportbuilder/tests/mock/rb_source_column_extra_id.php');

class corplms_reportbuilder_rb_base_source_testcase extends PHPUnit_Framework_TestCase {
    /**
