...
M.corplms_reportbuilder_expand = M.corplms_reportbuilder_expand || {
    /** Selectors. */
    SELECTORS: {
    ...
    init: function(Y, args) {
        $('body').on('click', '.rb-display-expand', M.corplms_reportbuilder_expand.displayExpand);
        $('body').on('click', this.SELECTORS.ENROLMENTBUTTONS, M.corplms_reportbuilder_expand.clickEnrol);
    },
    ...
    displayExpand: function(event) {
        ...
        var url = M.cfg.wwwroot + '/corplms/reportbuilder/ajax/expand.php?id=' + id + '&expandname=' + $(this).data('name');
        if ($(this).data('param')) {
    ...
    clickEnrol: function(event) {
        ...
        var id = $('.rb-display-table-container').attr('id');
        var url = M.cfg.wwwroot + '/corplms/reportbuilder/ajax/expand.php';
