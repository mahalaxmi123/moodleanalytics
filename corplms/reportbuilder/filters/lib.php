...
class rb_filter_type {
    ...
    private function get_filteroption($type, $value) {
        ...
        if (!$filteroption) {
            ...
            $a->value = $value;
            $a->source = $sourcename;
            debugging(get_string('error:filteroptiontypexandvalueynotfoundinz', 'corplms_reportbuilder', $a), DEBUG_DEVELOPER);
            return false;
        }
    ...
    private function get_columnoption($type, $value) {
        ...
        if (!$columnoption) {
            ...
            $a->value = $value;
            $a->source = $sourcename;
            debugging(get_string('error:columnoptiontypexandvalueynotfoundinz', 'corplms_reportbuilder', $a), DEBUG_DEVELOPER);
            return false;
        }
    ...
    private function get_joins($filteroption, $columnoption) {
        ...
        if (!reportbuilder::check_joins($this->report->src->joinlist, $joins)) {
            ...
            debugging(get_string('error:joinsforfiltertypexandvalueynotfoundinz', 'corplms_reportbuilder', $a), DEBUG_DEVELOPER);
            return false;
        }
    ...
    public static function get_filter($type, $value, $advanced, $region, $report) {
        ...
        $filename = "{$CFG->dirroot}/corplms/reportbuilder/filters/{$filtertype}.php";
    ...
    function get_sql_filter($data) {
        print_error('abstractmethodcalled', 'corplms_reportbuilder', '', 'get_sql_filter()');
    }
    ...
    function check_data($formdata) {
        print_error('abstractmethodcalled', 'corplms_reportbuilder', '', 'check_data()');
    }
    ...
    function setupForm(&$mform) {
        print_error('abstractmethodcalled', 'corplms_reportbuilder', '', 'setupForm()');
    }
    ...
    function get_label($data) {
        print_error('abstractmethodcalled', 'corplms_reportbuilder', '', 'get_label()');
    }
