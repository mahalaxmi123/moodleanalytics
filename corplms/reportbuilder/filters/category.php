...
class rb_filter_category extends rb_filter_type {
    ...
    public function setupForm(&$mform) {
        ...
        $objs[] =& $mform->createElement('static', 'selectorbutton',
            ...
            html_writer::empty_tag('input', array('type' => 'button',
                ...
                'value' => get_string('choosecatplural', 'corplms_reportbuilder'),
    ...
    public function get_label($data) {
        ...
        $a->value = implode(get_string($orandstr, 'corplms_reportbuilder'), $selected);
        if ($recursive) {
    ...
    public function include_js() {
        ...
        $jsdetails->strings = array(
            'corplms_reportbuilder' => array('choosecatplural'),
        );
