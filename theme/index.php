...
if (!empty($CFG->enabledevicedetection) && empty($device)) {
    ...
    foreach ($themes as $themename => $themedir) {
        ...
        //Hide the standard moodle theme from users, they should be using standardCorplms.
        //Do Not! remove the code though, the corplms themes require it.
        if ($themename == 'standard') {
            continue;
        }
        //Hide the standard mymobile theme from users, they should be using mymobilecorplms.
        //Do Not! remove the code though, the corplms themes require it.
