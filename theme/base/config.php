...
$THEME->sheets = array(
    ...
    'message',
    'question',
    'corplms_jquery_treeview',
    'corplms_jquery_datatables',
    'corplms_jquery_ui_dialog',  /** Generated file: see comments **/
    'corplms',   /**  Corplms-specific layout **/
    'user',
    'tabs',
    'filemanager'
);
...
$THEME->layouts = array(
    ...
    // this is only used by corplms pages
    'noblocks' => array(
        'file' => 'general.php',
        'regions' => array(),
