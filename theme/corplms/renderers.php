...
/**
 * Overriding core rendering functions for corplms.
 */
class theme_corplms_core_renderer extends core_renderer {
...
class theme_corplms_core_course_renderer extends core_course_renderer {
    /**
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $coursenamelink = html_writer::link(
            ...
            $coursename,
            array('class' => $dimmed, 'style' => 'background-image:url(' . corplms_get_icon($course->id, CORPLMS_ICON_TYPE_COURSE) . ')')
        );
