...
if (!empty($PAGE->theme->settings->logo)) {
    ...
    $logoalt = get_string('logo', 'theme_corplms', $SITE->fullname);
} else {
    $logourl = $OUTPUT->pix_url('logo', 'theme');
    $logoalt = get_string('corplmslogo', 'theme_corplms');
}
...
if ($showmenu && !$hascustommenu) {
    // load corplms menu
    $menudata = corplms_build_menu();
    $corplms_core_renderer = $PAGE->get_renderer('corplms_core');
    $corplmsmenu = $corplms_core_renderer->print_corplms_menu($menudata);
}
...
<header role="banner" class="navbar">
    <nav role="navigation" class="navbar-inner">
        <?php echo corplms_seedlings_header(); ?>
        <div class="container-fluid">
            ...
            <?php if ($showmenu) { ?>
                ...
                <?php } else { ?>
                <div id="corplmsmenu" class="nav-collapse collapse"><?php echo $corplmsmenu; ?></div>
                <?php } ?>
            <?php } ?>
        </div>
    </nav>
...
<footer id="page-footer">
    <div class="container-fluid">
        ...
        <div class="footer-powered">Powered by <a href="http://corplms.ballisticlearning.com/" target="_blank">CorpLMS</a></div>
        <?php
