...
class user_filtering {
    ...
    public function user_filtering($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('realname' => 0, 'lastname' => 1, 'firstname' => 1, 'email' => 1, 'city' => 1, 'country' => 1,
                                ...
                                'nevermodified' => 1, 'username' => 1, 'auth' => 1, 'mnethostid' => 1, 'corplmssync'=>1);
        }

        $systemcontext = context_system::instance();
        if (has_capability('corplms/core:seedeletedusers', $systemcontext)) {
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'deleted':   return new user_filter_yesno('deleted', get_string('deleted', 'corplms_core'), $advanced, 'deleted');
            case 'corplmssync':  return new user_filter_yesno('corplmssync', get_string('corplmssync', 'tool_corplms_sync'), $advanced, 'corplmssync');
            case 'auth':
