...
$string['configallowthemechangeonurl'] = 'If enabled, the theme can be changed by adding either:<br />?theme=themename to any Corplms URL (eg: mycorplmssite.com/?theme=afterburner ) or <br />&theme=themename to any internal Corplms URL (eg: mycorplmssite.com/course/view.php?id=2&theme=afterburner ).';
...
<pre>
Corplms community|http://community.corplmslms.com
Corplms support|http://support.corplmslms.com
Corplms development|http://dev.corplmslms.com
-Corplms help|http://help.corplmslms.com
Corplms News|http://www.corplmslms.com/about-corplms/news
Corplms Partners|http://www.corplmslms.com/partners
</pre>';
...
$string['configdocroot'] = 'Defines the path to the Corplms Docs for providing context-specific documentation via \'Corplms Docs for this page\' links in the footer of each page. If the field is left blank, links will not be displayed.';
$string['configdoctonewwindow'] = 'If you enable this, then links to Corplms Docs will be shown in a new window.';
...
$string['configenablemobilewebservice'] = 'Enable mobile service for the official Corplms app or other app requesting it. For more information, read the {$a}';
...
$string['configenablestats'] = 'If you choose \'yes\' here, Corplms\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your courses, or on a sitewide basis.';
$string['configenabletrusttext'] = 'By default Corplms will always thoroughly clean text that comes from users to remove any possible bad scripts, media etc that could be a security risk.  The Trusted Content system is a way of giving particular users that you trust the ability to include these advanced features in their content without interference.  To enable this system, you need to first enable this setting, and then grant the Trusted Content permission to a specific Corplms role.  Texts created or uploaded by such users will be marked as trusted and will not be cleaned before display.';
$string['configenablewebservices'] = 'Web services enable other systems to log in to this Corplms and perform operations.  For extra security this feature should be disabled unless you are really using it.';
...
$string['configintro'] = 'On this page you can specify a number of configuration variables that help make Corplms work properly on your server.  Don\'t worry too much about it - the defaults will usually work fine and you can always come back to this page later and change these settings.';
...
$string['configlangstringcache'] = 'Caches all the language strings into compiled files in the data directory.  If you are translating Corplms or changing strings in the Corplms source code then you may want to switch this off.  Otherwise leave it on to see performance benefits.';
$string['configlanglist'] = 'Leave this blank to allow users to choose from any language you have in this installation of Corplms.  However, you can shorten the language menu by entering a comma-separated list of language codes that you want.  For example:  en,es_es,fr,it';
...
$string['configloginhttps'] = 'Turning this on will make Corplms use a secure https connection just for the login page (providing a secure login), and then afterwards revert back to the normal http URL for general speed.  CAUTION: this setting REQUIRES https to be specifically enabled on the web server - if it is not then YOU COULD LOCK YOURSELF OUT OF YOUR SITE.';
...
$string['configmessaging'] = 'Should the messaging system between site users be enabled? (Note: Corplms alerts and tasks depend on this)';
...
$string['configpasswordpolicy'] = 'Turning this on will make Corplms check user passwords against a valid password policy. Use the settings below to specify your policy (they will be ignored if you set this to \'No\').';
...
$string['configrecaptchaprivatekey'] = 'String of characters used to communicate between your Corplms server and the recaptcha server. Obtain one for this site by visiting http://www.google.com/recaptcha';
...
$string['configsecureforms'] = 'Corplms can use an additional level of security when accepting data from web forms. If this is enabled, then the browser\'s HTTP_REFERER variable is checked against the current form address.  In a very few cases this can cause problems if the user is using a firewall (eg Zonealarm) configured to strip HTTP_REFERER from their web traffic.  Symptoms are getting \'stuck\' on a form. If your users are having problems with the login page (for example) you might want to disable this setting, although it might leave your site more open to brute-force password attacks.  If in doubt, leave this set to \'Yes\'.';
$string['configsessioncookie'] = 'This setting customises the name of the cookie used for Corplms sessions.  This is optional, and only useful to avoid cookies being confused when there is more than one copy of Corplms running within the same web site.';
$string['configsessioncookiedomain'] = 'This allows you to change the domain that the Corplms cookies are available from. This is useful for Corplms customisations (e.g. authentication or enrolment plugins) that need to share Corplms session information with a web application on another subdomain. <strong>WARNING: it is strongly recommended to leave this setting at the default (empty) - an incorrect value will prevent all logins to the site.</strong>';
$string['configsessioncookiepath'] = 'If you need to change where browsers send the Corplms cookies, you can change this setting to specify a subdirectory of your web site.  Otherwise the default \'/\' should be fine.';
...
$string['configslasharguments'] = '\'Slash arguments\' (using <em>PATH_INFO</em>) is required for SCORM packages and multiple-file resources to display correctly. If your web server doesn\'t support \'slash arguments\' and you are unable to configure it, this setting can be disabled, though it will result in things not working.<br />Note: The use of \'slash arguments\' will be required in future versions of Corplms.';
$string['configsmartpix'] = 'With this on, icons are served through a PHP script that searches the current theme, then all parent themes, then the Corplms /pix folder. This reduces the need to duplicate image files within themes, but has a slight performance cost.';
...
$string['configstatsruntimestart'] = 'What time should the cronjob that does the statistics processing start? Specifying different times is recommended if there are multiple Corplms sites on one server.';
...
$string['cron'] = 'Cron';
$string['cron_help'] = 'The cron.php maintenance script assists some of Corplms\'s modules to perform tasks on a scheduled basis, such as mailing out copies of new forum posts. A mechanism is required to run the script regularly e.g. every 5 minutes.';
...
$string['ctyperequired'] = 'The ctype PHP extension is now required by Corplms, in order to improve site performance and to offer multilingual compatibility.';
$string['curlcache'] = 'cURL cache TTL';
$string['curlrequired'] = 'The cURL PHP extension is now required by Corplms, in order to communicate with Corplms repositories.';
...
$string['docroot'] = 'Corplms Docs document root';
...
$string['enablegravatar_help'] = 'When enabled Corplms will attempt to fetch a user profile picture from Gravatar if the user has not uploaded an image.';
...
$string['environmenterrortodo'] = 'You must solve all the environmental problems (errors) found above before proceeding to install this Corplms version!';
$string['environmenterrorupgrade'] = 'Warning: you should solve all the environmental problems (errors) found above before proceeding to upgrade this Corplms version!  Upgrading without fixing these requirements could cause problems such as data loss.  Are you sure you want to continue with the upgrade?';
...
$string['fatalsessionautostart'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, Corplms requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['groupenrolmentkeypolicy_desc'] = 'Turning this on will make Corplms check group enrolment keys against a valid password policy.';
...
$string['helpcalendarsettings'] = 'Configure various calendar and date/time-related aspects of Corplms';
...
$string['iplookupinfo'] = 'By default Corplms uses the free online NetGeo (The Internet Geographic Database) server to lookup location of IP addresses, unfortunately this database is not maintained anymore and may return <em>wildly incorrect</em> data.
...
$string['langpackwillbeupdated'] = 'NOTE: Corplms will try to download updates for your language packs during the upgrade.';
...
$string['maturitycorewarning'] = 'The version of Corplms that you are about to install or upgrade to contains
...
from a STABLE branch of the Corplms code. See Corplms Docs for more details.';
...
$string['mnetrestore_extusers'] = '<strong>Note:</strong> This backup file contains remote Corplms Network user accounts which will be restored as part of the process.';
$string['mnetrestore_extusers_admin'] = '<strong>Note:</strong> This backup file seems to come from a different Corplms installation and contains remote Corplms Network user accounts. The restore process will try to match the Corplms Network hosts for all created users. Those not matching will be automatically switched to internal authentication (instead of mnet one). The restore log will inform you about that.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Note:</strong> This backup file apparently originates from a different Corplms installation and contains remote Corplms Network user accounts that may fail to restore. This operation is unsupported. If you are certain that it was created on this Corplms installation, or you can ensure that all the needed Corplms Network Hosts are configured, you may want to still try the restore.';
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different Corplms installation and contains remote Corplms Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this course without any user information (modules, files...)';
$string['mnetrestore_extusers_switchuserauth'] = 'Remote Corplms Network user {$a->username} (coming from {$a->mnethosturl}) switched to local {$a->auth} authenticated user.';
...
$string['nohttpsformobilewarning'] = 'It is recommended to enable HTTPS with a valid certificate. The Corplms app will always try to use a secured connection first.';
...
$string['opensslrecommended'] = 'Installing the optional OpenSSL library is highly recommended -- it enables Corplms Networking functionality.';
...
$string['pathtodot_help'] = 'Path to dot. Probably something like /usr/bin/dot. To be able to generate graphics from DOT files, you must have installed the dot executable and point to it here. Note that, for now, this only used by the profiling features (Development->Profiling) built into Corplms.';
...
$string['pluginschecktodo'] = 'You must solve all the plugin requirements before proceeding to install this Corplms version!';
...
$string['profilingallowall_help'] = 'If you enable this setting, then, at any moment, you can use the PROFILEALL parameter anywhere (PGC) to enable profiling for all the executed scripts along the Corplms session life. Analogously, you can use the PROFILEALLSTOP parameter to stop it.';
...
$string['releasenoteslink'] = 'For information about this version of Corplms, please see the <a target="_blank" href="{$a}">Change Logs</a>';
...
$string['purgecachesconfirm']= 'Corplms can cache themes, javascript, language strings, filtered text, rss feeds and many other pieces of calculated data.  Purging these caches will delete that data from the server and force browsers to refetch data, so that you can be sure you are seeing the most up-to-date values produced by the current code.  There is no danger in purging caches, but your site may appear slower for a while until the server and clients calculate new information and cache it.';
...
$string['sessionautostartwarning'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, Corplms requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['settingsafemode'] = 'Corplms is not fully compatible with safe mode, please ask server administrator to turn it off. Running Corplms under safe mode is not supported, please expect various problems if you do so.';
...
$string['simplexmlrequired'] = 'The SimpleXML PHP extension is now required by Corplms.';
...
$string['splrequired'] = 'The SPL PHP extension is now required by Corplms.';
...
$string['tokenizerrecommended'] = 'Installing the optional PHP Tokenizer extension is recommended -- it improves Corplms Networking functionality.';
...
$string['upgradesettingsintro'] = 'The settings shown below were added during your last Corplms upgrade. Make any changes necessary to the defaults and then click the &quot;Save changes&quot; button at the bottom of this page.';
$string['upgradestalefiles'] = 'Mixed Corplms versions detected, upgrade cannot continue';
$string['upgradestalefilesinfo'] = 'The Corplms update process has been paused because PHP scripts from at least two major versions of Corplms have been detected in the Corplms directory.

This can cause significant problems later, so in order to continue you must ensure that the Corplms directory contains only files for a single version of Corplms.

The recommended way to clean your Corplms directory is as follows:

* rename the current Corplms directory to "corplms_old"
* create a new Corplms directory containing only files from a standard Corplms package download
* move the original config.php file and any non-standard plugins from the "corplms_old" directory to the new Corplms directory

When you have a clean Corplms directory, refresh this page to resume the Corplms update process.

This warning is often caused by unzipping a standard Corplms package over a previous version of Corplms. While this is OK for minor upgrades, it is strongly discouraged for major Corplms upgrades.
...
$string['upgradesure'] = '<p>Your Corplms files have been changed, and you are about to automatically upgrade your server from this version:</p>
...
$string['webproxyinfo'] = 'Fill in following options if your Corplms server can not access internet directly. Internet access is required for download of environment data, language packs, RSS feeds, timezones, etc.<br /><em>PHP cURL extension is highly recommended.</em>';
$string['xmlrpcrecommended'] = 'The xmlrpc extension is needed for hub communication, and useful for web services and Corplms networking';
$string['xmlstrictheaders'] = 'XML strict headers';
$string['yuicomboloading'] = 'YUI combo loading';
$string['ziprequired'] = 'The Zip PHP extension is now required by Corplms, info-ZIP binaries or PclZip library are not used anymore.';
...
$string['moodlerelease'] = 'Corplms release identifier';
...
$string['registrationisdisabled'] = 'Corplms registration is disabled.  Configuring your site to register basic information with Corplms is recommended to assist in troubleshooting any future issues you may have.<br />
You can enable registration from the <a href="{$a}">registration configuration page</a>';
$string['registrationisenabled'] = 'The site has been successfully registered with Corplms.';
$string['registrationoutofdate'] = 'Corplms registration information has not been updated for an extended period of time. Registration information should be kept up-to-date to assist possible future troubleshooting. Ensure that your webserver has unrestricted access to make https requests to register.corplmslms.com';
$string['save'] = 'Save';
$string['sitefullname'] = 'Site Fullname';
$string['sitehasntregistered'] = 'This site has not yet successfully registered with Corplms. Registering basic information with Corplms is recommended to assist in troubleshooting any future issues you may have.  Ensure your webserver is able to make https requests to register.corplmslms.com and that the Corplms cron is enabled. You can run the cron manually by <a href="{$a}">clicking here</a>';
