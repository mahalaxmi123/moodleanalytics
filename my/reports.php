...
$strheading = get_string('myreports', 'corplms_core');
...
echo corplms_print_report_manager();
...
if (reportbuilder_get_reports()){
    ...
    echo $OUTPUT->heading(get_string('scheduledreports', 'corplms_reportbuilder'), 2, null, 'scheduled');

    corplms_print_scheduled_reports();
    echo $OUTPUT->container_end();
    echo $OUTPUT->container_end();
}
