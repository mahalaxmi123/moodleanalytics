...
$strheading = get_string('teammembers', 'corplms_core');
...
$PAGE->navbar->add(get_string('myteam', 'corplms_core'));
...
echo html_writer::tag('p', get_string('teammembers_text', 'corplms_core'));
