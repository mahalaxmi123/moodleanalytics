...
//Course types
define('CORPLMS_COURSE_TYPE_ELEARNING', 0);
define('CORPLMS_COURSE_TYPE_BLENDED', 1);
define('CORPLMS_COURSE_TYPE_FACETOFACE', 2);

global $CORPLMS_COURSE_TYPES;
$CORPLMS_COURSE_TYPES = array(
    'elearning' => CORPLMS_COURSE_TYPE_ELEARNING,
    'blended' => CORPLMS_COURSE_TYPE_BLENDED,
    'facetoface' => CORPLMS_COURSE_TYPE_FACETOFACE,
);
...
function make_log_url($module, $url) {
    switch ($module) {
        ...
        case 'program':
        case 'plan':
            $url = '/corplms/' . $module . '/' . $url;
            break;
        case 'position':
        case 'organisation':
        case 'competency':
        case 'goal':
            $url = '/corplms/hierarchy/' . $url;
            break;
        case 'priorityscales':
        case 'objectivescales':
            $url = '/corplms/plan/' . $module . '/' . $url;
            break;
        case 'my':
            $url = '/my/' . $url;
            break;
        // End Corplms specific modules
        case 'grade':
            $url = "/grade/$url";
            break;
        case 'rbembedded':
...
function can_edit_in_category($categoryid = 0) {
    ...
    return has_any_capability(array('moodle/category:manage', 'moodle/course:create',
                                    'moodle/course:update', 'corplms/program:createprogram', 'corplms/program:configuredetails',
                                    'corplms/certification:createcertification', 'corplms/certification:configurecertification'),
                              $context);
}
