...
class core_course_management_renderer extends plugin_renderer_base {
    ...
    public function management_buttons($categoryid) {
        ...
        if (corplms_feature_visible('programs')) {
            ...
            $url = new moodle_url('/corplms/program/manage.php', array('categoryid' => $categoryid));
            $programcaps = array('corplms/program:createprogram', 'corplms/program:deleteprogram', 'corplms/program:configuredetails');
        ...
        if (corplms_feature_visible('certifications')) {
            ...
            $url = new moodle_url('/corplms/program/manage.php', array('categoryid' => $categoryid, 'viewtype' => 'certification'));
