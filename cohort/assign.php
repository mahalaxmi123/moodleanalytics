...
$currentcohortroles = corplms_get_cohort_roles($cohort->id);
...
if (optional_param('add', false, PARAM_BOOL) && confirm_sesskey()) {
    ...
    if (!empty($userstoassign)) {
        ...
        corplms_set_role_assignments_cohort($currentcohortroles, $cohort->id, array_keys($newids));
        // Notify users.
        corplms_cohort_notify_add_users($cohort->id, $newids);
...
if (optional_param('remove', false, PARAM_BOOL) && confirm_sesskey()) {
    ...
    if (!empty($userstoremove)) {
        ...
        corplms_unset_role_assignments_cohort($currentcohortroles, $cohort->id, array_keys($delids));
        // Notify users.
        corplms_cohort_notify_del_users($cohort->id, $delids);
