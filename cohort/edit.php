...
if ($editform->is_cancelled()) {
    ...
    if ($data->id) {
        ...
        corplms_set_notification(get_string('successfullyupdated','corplms_cohort'), $url, array('class' => 'notifysuccess'));
    } else {
        ...
        if ($data->cohorttype == cohort::TYPE_STATIC) {
            ...
            $url = new moodle_url('/corplms/cohort/rules.php', array('id' => $cohortid));
        }
        redirect($url);
    }
