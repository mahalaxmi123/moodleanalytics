...
/**
 * Alert message processor - stores the message to be shown using the corplms alert notification system
 */

require_once($CFG->dirroot.'/message/output/lib.php');
require_once($CFG->dirroot.'/corplms/message/messagelib.php');

class message_output_corplms_alert extends message_output{
    ...
    public function send_message($eventdata) {
        ...
        if (empty($processorid)) {
            $processor = $DB->get_record('message_processors', array('name' => 'corplms_alert'), '*', MUST_EXIST);
