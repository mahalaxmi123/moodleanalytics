...
$PAGE->requires->string_for_js('currentlyselected', 'corplms_hierarchy');
$jsmodule = array(
...
echo html_writer::empty_tag('input', array('type' => 'button', 'value' => get_string('chooseposition', 'corplms_hierarchy'), 'id' => 'show-position-dialog'));
echo $OUTPUT->container_end();

echo $OUTPUT->container_start();
echo html_writer::tag('span', '', array('class' => '', 'id' => 'organisationtitle'));
echo html_writer::empty_tag('input', array('type' => 'button', 'value' => get_string('chooseorganisation', 'corplms_hierarchy'), 'id' => 'show-organisation-dialog'));
echo $OUTPUT->container_end();

echo $OUTPUT->container_start();
echo html_writer::tag('span', '', array('class' => '', 'id' => 'managertitle'));
echo html_writer::empty_tag('input', array('type' => 'button', 'value' => get_string('choosemanager', 'corplms_hierarchy'), 'id' => 'show-manager-dialog'));
echo $OUTPUT->container_end();
