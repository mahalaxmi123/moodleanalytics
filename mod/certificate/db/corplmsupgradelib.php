...
/**
 * Function for Corplms specific DB changes to core Moodle modules.
 *
 * Put code here rather than in db/upgrade.php if you need to change core
 * Moodle database schema for Corplms-specific changes.
 *
 ...
 */
function mod_certificate_corplms_upgrade($oldversion) {
    global $DB;
