...
function xmldb_certificate_upgrade($oldversion=0) {
    ...
    // Do not put Corplms upgrade code in this file - put it in
    // corplmsupgradelib.php instead and it will be called on every
    // upgrade.
    // Always keep this at the end of upgrade and bump up the main
    // version by .01 after merging upstream changes!
    require_once(__DIR__ . '/corplmsupgradelib.php');
    mod_certificate_corplms_upgrade($oldversion);
