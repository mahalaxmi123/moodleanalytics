...
function xmldb_feedback_upgrade($oldversion) {
    ...
    // Corplms upgrade line - all Corplms hacks must be done after all other Moodle upgrades!
    ...
    if ($oldversion < 2014051200.01) {
        ...
        /// Undo Corplms grade support in feedback from T-9604, not used any more.
