...
function xmldb_facetoface_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2013013000) {
        ...
        if ($fixsessions) {
            ...
            if ($badusers > 0 || $unknownusercount > 0) {
                ...
                $info = get_string('badusertimezonemessage', 'tool_corplms_timezonefix');
    ...
    // Corplms 2.6.x upgrade line - bump all version numbers below after merge from t2-release-26 if necessary.
