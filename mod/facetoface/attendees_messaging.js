...
M.corplms_f2f_attendees_messaging = M.corplms_f2f_attendees_messaging || {
    ...
    init: function(Y, args){
        ...
        (function() {
            var handler = new corplmsDialog_handler_editrecipients();
            ...
            default_url = M.cfg.wwwroot + '/mod/facetoface/editrecipients.php?s=' + M.corplms_f2f_attendees_messaging.config.sessionid;
        ...
        $('input#id_recipient_custom').click(function() {
            ...
            corplmsDialogs['editrecipients'].default_url = default_url + '&recipients=' + selected;
            corplmsDialogs['editrecipients'].open();
        });
 ...
 */
corplmsDialog_handler_editrecipients = function() {};
corplmsDialog_handler_editrecipients.prototype = new corplmsDialog_handler();

/**
 * Update recipients form with selected recipients
 */
corplmsDialog_handler_editrecipients.prototype.update_recipients = function() {
