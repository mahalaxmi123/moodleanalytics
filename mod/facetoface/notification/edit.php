...
$jsmodule = array(
    'name' => 'corplms_f2f_notification_template',
    'fullpath' => '/mod/facetoface/notification/get_template.js',
    'requires' => array('json', 'corplms_core'));

$PAGE->requires->js_init_call('M.corplms_f2f_notification_template.init', $args, false, $jsmodule);
...
if ($form->is_cancelled()) {
    ...
    corplms_set_notification(get_string('notificationsaved', 'facetoface'), $redirectto, array('class' => 'notifysuccess'));
}
