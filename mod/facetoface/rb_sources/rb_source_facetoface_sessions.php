...
class rb_source_facetoface_sessions extends rb_base_source {
    ...
    public function rb_filter_position_types_list() {
        ...
        include_once($CFG->dirroot.'/corplms/hierarchy/prefix/position/lib.php');
    ...
    public function rb_display_position_type($position, $row) {
        ...
        return get_string('type'.$POSITION_TYPES[$position], 'corplms_hierarchy');
    }
    ...
    public function post_config(reportbuilder $report) {
        ...
        $report->set_post_config_restrictions(corplms_visibility_where($userid,
