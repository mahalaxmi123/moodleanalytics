...
if ($form->is_cancelled()) {
    ...
    if (isset($data->submitbutton)) {
        ...
        if ($data->id == 0) {
            ...
            corplms_set_notification(get_string('roomcreatesuccess', 'facetoface'), $roomlisturl, array('class' => 'notifysuccess'));
        } else {
            // Update room.
            $todb->id = $room->id;
            ...
            corplms_set_notification(get_string('roomupdatesuccess', 'facetoface'), $roomlisturl, array('class' => 'notifysuccess'));
        }
    }
}
