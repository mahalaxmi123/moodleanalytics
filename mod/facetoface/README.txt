...
Copyright (C) 2010 onwards Corplms LMS (http://www.corplmslms.com)
...
https://github.com/corplms/facetoface-2.0/tree/moodle-2.1.x
...
Feel free to send bug reports (and/or patches!) to the current maintainer:
  ...
  Alastair Munro <alastair.munro@corplmslms.com>
