...
$string['aiccuserid_desc'] = 'The AICC standard for usernames is very restrictive compared with Corplms. It allows for alpha-numeric characters, dash and underscore only. Periods, spaces and the @ symbol are not permitted. If enabled, user ID numbers are passed to the AICC package instead of usernames.';
