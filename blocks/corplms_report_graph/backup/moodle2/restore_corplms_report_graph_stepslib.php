...
class restore_corplms_report_graph_block_structure_step extends restore_structure_step {
    ...
    protected function define_structure() {
        ...
        $paths[] = new restore_path_element('corplms_report_graph', '/block/corplms_report_graph');
