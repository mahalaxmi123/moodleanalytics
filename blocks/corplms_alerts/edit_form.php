...
class block_corplms_alerts_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('select', 'config_showempty', get_string('showempty', 'block_corplms_alerts'), $options, $attributes);
