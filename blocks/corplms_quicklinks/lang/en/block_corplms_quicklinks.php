...
$string['corplms_quicklinks:addinstance'] = 'Add a new quicklinks block';
$string['corplms_quicklinks:myaddinstance'] = 'Add a new quicklinks block to My Moodle page';
$string['corplms_quicklinks:manageownlinks'] = 'Manage own links';
