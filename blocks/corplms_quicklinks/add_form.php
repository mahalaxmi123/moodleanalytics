...
class corplms_quicklinks_add_quicklink_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('text', 'linktitle', get_string('linktitle', 'block_corplms_quicklinks'));
        $mform->addRule('linktitle', null, 'required', null, 'client');
        $mform->setType('linktitle', PARAM_TEXT);
        $mform->addElement('text', 'linkurl', get_string('url', 'block_corplms_quicklinks'));
