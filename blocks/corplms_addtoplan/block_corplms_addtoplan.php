...
class block_corplms_addtoplan extends block_base {

    function init() {
        $this->title = get_string('pluginname', 'block_corplms_addtoplan');
    }
    ...
    function get_content() {
        ...
        $jsmodule = array(
            'name' => 'block_corplms_addtoplan',
            'fullpath' => '/blocks/corplms_addtoplan/block.js',
            'requires' => array('json'));
        $this->page->requires->js_init_call('M.block_corplms_addtoplan.init', $args, false, $jsmodule);
        ...
        $this->content->text = corplms_block_addtoplan_get_content($COURSE->id, $USER->id);
