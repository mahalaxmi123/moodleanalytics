 ...
 * @package corplms
 * @subpackage corplms_recent_learning
 */
 ...
 */
class block_corplms_recent_learning extends block_base {

    public function init() {
        $this->title   = get_string('recentlearning', 'block_corplms_recent_learning');
    ...
    public function get_content() {
        ...
        if (!$courses) {
            $this->content->text = get_string('norecentlearning', 'block_corplms_recent_learning');
            return $this->content;
        }
        if ($courses) {
            ...
            foreach ($courses as $course) {
                ...
                $completion = corplms_display_course_progress_icon($USER->id, $course->id, $status);
            ...
            $this->content->footer = html_writer::link(new moodle_url('/corplms/plan/record/courses.php', array('userid' => $USER->id)), get_string('allmycourses', 'corplms_core'));
        }
